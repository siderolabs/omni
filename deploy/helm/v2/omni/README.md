...
For full configuration reference, see the [config schema](https://github.com/siderolabs/omni/blob/main/internal/pkg/config/schema.json).
...
3. **Wildcard DNS record** pointing `*.<subdomain>.<parent-domain>` to your ingress controller IP.
