...
![Version: 2.5.10](https://img.shields.io/badge/Version-2.5.10-informational?style=flat) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat) ![AppVersion: v1.5.10](https://img.shields.io/badge/AppVersion-v1.5.10-informational?style=flat)
...
| auth.auth0.clientId | string | `"123456"` |  |
| auth.auth0.domain | string | `"example.auth0.com"` |  |
| auth.auth0.enabled | bool | `true` |  |
| auth.saml.enabled | bool | `false` |  |
| auth.saml.url | string | `"https://www.saml.example"` |  |
| customVolumeMounts | string | `nil` |  |
| customVolumes | string | `nil` |  |
| deployment.annotations | object | `{}` |  |
| deployment.image | string | `"ghcr.io/siderolabs/omni"` |  |
| deployment.imagePullPolicy | string | `"IfNotPresent"` |  |
| deployment.replicaCount | int | `1` |  |
| deployment.tag | string | `"latest"` |  |
| domainName | string | `"omni.example.com"` |  |
| extraArgs | string | `nil` |  |
| includeGenericDevicePlugin | bool | `true` |  |
| initialUsers | list | `[]` |  |
| name | string | `"My Omni instance"` |  |
| privateKeySource | string | `"file:///omni.asc"` |  |
| resources.limits."squat.ai/tun" | int | `1` |  |
| resources.limits.cpu | string | `"200m"` |  |
| resources.limits.memory | string | `"256Mi"` |  |
| resources.requests.cpu | string | `"100m"` |  |
| resources.requests.memory | string | `"128Mi"` |  |
| service.k8sProxy.domainName | string | `"omni.kubernetes.example.com"` |  |
| service.siderolink.domainName | string | `"omni.siderolink.example.com"` |  |
| service.siderolink.wireguard.address | string | `""` |  |
| service.siderolink.wireguard.port | int | `30180` |  |
| service.type | string | `"ClusterIP"` |  |
| volumeMounts.omniAsc.mountPath | string | `"/omni.asc"` |  |
| volumeMounts.omniAsc.readOnly | bool | `true` |  |
| volumeMounts.omniAsc.subPath | string | `"omni.asc"` |  |
| volumeMounts.tls.mountPath | string | `nil` |  |
| volumeMounts.tls.readOnly | bool | `true` |  |
| volumes.etcd.persistentVolumeClaimName | string | `"omni-pvc"` |  |
| volumes.gpg.secretName | string | `"gpg"` |  |
| volumes.tls.secretName | string | `nil` |  |
