...
#
# Generated on 2026-06-03T14:53:56Z by kres a07fce6.
...
ARG TAG
WORKDIR /src
RUN SYFT_FORMAT_PRETTY=1 SYFT_FORMAT_SPDX_JSON_DETERMINISTIC_UUID=1 syft scan dir:/src --source-name omni --source-version "${TAG}" -o spdx-json=/sbom.spdx.json -o cyclonedx-json=/sbom.cyclonedx.json
