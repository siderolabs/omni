...
func TestCheckTalosVersion(t *testing.T) {
	...
	m := lifecycle.NewManager(zapNop(t), "factory", "ghcr.io/siderolabs/installer", nil, nil, nil)
...
func TestRunReleasesSlotOnFailure(t *testing.T) {
	...
	m := lifecycle.NewManager(zapNop(t), "factory.talos.dev", "ghcr.io/siderolabs/installer", nil, nil, nil)
