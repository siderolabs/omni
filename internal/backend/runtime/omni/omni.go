...
func NewRuntime(cfg *config.Params, talosClientFactory *talos.ClientFactory, dnsService *dns.Service, workloadProxyReconciler *workloadproxy.Reconciler,
	...
	qcontrollers := []controller.QController{
		...
		machineconfig.NewClusterMachineConfigStatusController(talosClientFactory, imageFactoryHost, cfg.Registries.GetTalos()),
		...
		omnictrl.NewControlPlaneStatusController(talosClientFactory),
		...
		omnictrl.NewMachineSetStatusController(talosClientFactory),
		...
		omnictrl.NewMachineTeardownController(talosClientFactory),
		...
		machineupgrade.NewStatusController(imageFactoryHost, cfg.Registries.GetTalos(), talosClientFactory),
