...
func NewContext[Input, Output generic.ResourceWithRD](runtime controller.ReaderWriter, input Input, output Output,
	initialStage Stage[Input, Output], stages []Stage[Input, Output],
) Context[Input, Output] {
	stages = append([]Stage[Input, Output]{initialStage}, stages...)
