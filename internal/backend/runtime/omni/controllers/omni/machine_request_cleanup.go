...
type MachineRequestStatusCleanupController = cleanup.Controller[*cloud.MachineRequestStatus]
...
func NewMachineRequestStatusCleanupController() *MachineRequestStatusCleanupController {
	return cleanup.NewController(
		cleanup.Settings[*cloud.MachineRequestStatus]{
			Name: "MachineRequestStatusCleanupController",
			Handler: cleanup.Combine(
				helpers.NewCustomHandler[*cloud.MachineRequestStatus, *omni.MachineSetNode](
					helpers.MapID[*cloud.MachineRequestStatus, *omni.MachineSetNode](func(req *cloud.MachineRequestStatus) resource.ID {
						return req.TypedSpec().Value.Id
					}, true),
					false,
				),
				helpers.NewCustomHandler[*cloud.MachineRequestStatus, *omni.ClusterMachine](
					func(ctx context.Context, r controller.Runtime, req *cloud.MachineRequestStatus, _ string) error {
				...
				helpers.NewCustomHandler[*cloud.MachineRequestStatus, *siderolink.Link](
					func(ctx context.Context, r controller.Runtime, req *cloud.MachineRequestStatus, _ string) error {
