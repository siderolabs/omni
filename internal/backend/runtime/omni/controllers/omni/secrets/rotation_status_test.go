	...
	t.Run("no rotation", func(t *testing.T) {
		...
		testutils.WithRuntime(ctx, t, testutils.TestOptions{},
			func(ctx context.Context, testContext testutils.TestContext) {
				...
				require.NoError(t, testContext.Runtime.RegisterQController(omnictrl.NewClusterMachineConfigController("test.factory", nil, "ghcr.io/siderolabs")))
				require.NoError(t, testContext.Runtime.RegisterQController(machineconfig.NewClusterMachineConfigStatusController("test.factory", "ghcr.io/siderolabs")))
			},
			func(ctx context.Context, testContext testutils.TestContext) {
