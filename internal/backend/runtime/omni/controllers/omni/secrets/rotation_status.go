...
// InitialStage returns the initial stage of the secret rotation status controller.
func (s *Rotator) InitialStage() sequence.Stage[*omni.ClusterSecrets, *omni.ClusterSecretsRotationStatus] {
	return sequence.NewInitialStage(specs.SecretRotationSpec_OK.String(), s.createInitialStage(specs.SecretRotationSpec_OK))
}

// ExtraStages returns the extra stages of the secret rotation status controller.
func (s *Rotator) ExtraStages() []sequence.Stage[*omni.ClusterSecrets, *omni.ClusterSecretsRotationStatus] {
