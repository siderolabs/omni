...
func TestAudit(t *testing.T) {
	...
	actions := []func(*testing.T){
		func(t *testing.T) {
			require.NoError(t, l.LogCreate(createCtx(), res))
		},
		func(t *testing.T) {
			res.TypedSpec().Value.Confirmed = true

			require.NoError(t, l.LogUpdate(createCtx(), res))
		},
		func(t *testing.T) {
			res.TypedSpec().Value.Confirmed = false

			require.NoError(t, l.LogUpdateWithConflicts(createCtx(), res))
		},
		func(t *testing.T) {
			require.NoError(t, l.LogDestroy(createCtx(), res.Metadata()))
		},
		func(t *testing.T) {
			require.NoError(t, l.LogCreate(createCtx(), res))
		},
