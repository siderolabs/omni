...
func publicKeyUpdate(_ context.Context, data *audit.Data, res *auth.PublicKey, _ ...state.UpdateOption) error {
	return handlePublicKey(data, res)
}
...
func userUpdate(_ context.Context, data *audit.Data, res *auth.User, _ ...state.UpdateOption) error {
	return handleUser(data, res)
}
...
func identityUpdate(_ context.Context, data *audit.Data, res *auth.Identity, _ ...state.UpdateOption) error {
	return handleIdentity(data, res)
}
...
func machineUpdate(_ context.Context, data *audit.Data, res *omni.Machine, _ ...state.UpdateOption) error {
	return handleMachine(data, res)
}
...
func machineLabelsUpdate(_ context.Context, data *audit.Data, res *omni.MachineLabels, _ ...state.UpdateOption) error {
	initPtrField(&data.MachineLabels)
...
func accessPolicyUpdate(_ context.Context, data *audit.Data, res *auth.AccessPolicy, _ ...state.UpdateOption) error {
	return handleAccessPolicy(data, res)
}
...
func clusterUpdate(_ context.Context, data *audit.Data, res *omni.Cluster, _ ...state.UpdateOption) error {
	return handleCluster(data, res)
}
