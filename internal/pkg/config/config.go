...
//go:generate go tool go-jsonschema --only-models --struct-name-from-title --tags=json,yaml --package=config --extra-imports -o=types.generated.go schema.json

//go:generate go tool go-accessor-gen --source=types.generated.go --output=accessors.generated.go
