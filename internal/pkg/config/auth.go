...
type Auth struct {
	...
	Auth0 Auth0 `yaml:"auth0" validate:"excluded_with=WebAuthn SAML"`
	// WebAuthn auth type configuration.
	WebAuthn WebAuthn `yaml:"webauthn" validate:"excluded_with=Auth0 SAML"`
	// SAML auth type configuration.
	SAML SAML `yaml:"saml" validate:"excluded_with=Auth0 WebAuthn"`
