...
func init() {
	...
	rootCmd.Flags().BoolVar(&config.Config.Auth.Auth0.UseFormData, "auth-auth0-use-form-data", config.Config.Auth.Auth0.UseFormData, "When true, data to the token endpoint is transmitted as x-www-form-urlencoded data instead of JSON. The default is false")
