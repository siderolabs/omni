...
func (m *TearDownLockedClusterRequest) CloneVT() *TearDownLockedClusterRequest {
	if m == nil {
		return (*TearDownLockedClusterRequest)(nil)
	}
	r := new(TearDownLockedClusterRequest)
...
func (m *TearDownLockedClusterRequest) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *TearDownLockedClusterResponse) CloneVT() *TearDownLockedClusterResponse {
	if m == nil {
		return (*TearDownLockedClusterResponse)(nil)
	}
	r := new(TearDownLockedClusterResponse)
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *TearDownLockedClusterResponse) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *TearDownLockedClusterRequest) EqualVT(that *TearDownLockedClusterRequest) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *TearDownLockedClusterRequest) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*TearDownLockedClusterRequest)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *TearDownLockedClusterResponse) EqualVT(that *TearDownLockedClusterResponse) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *TearDownLockedClusterResponse) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*TearDownLockedClusterResponse)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *TearDownLockedClusterRequest) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *TearDownLockedClusterRequest) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *TearDownLockedClusterRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *TearDownLockedClusterResponse) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *TearDownLockedClusterResponse) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *TearDownLockedClusterResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *TearDownLockedClusterRequest) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TearDownLockedClusterResponse) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TearDownLockedClusterRequest) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TearDownLockedClusterRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TearDownLockedClusterRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TearDownLockedClusterResponse) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TearDownLockedClusterResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TearDownLockedClusterResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
