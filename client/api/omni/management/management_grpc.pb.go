...
func (c *managementServiceClient) MachineLogs(ctx context.Context, in *MachineLogsRequest, opts ...grpc.CallOption) (ManagementService_MachineLogsClient, error) {
	...
	x := &managementServiceMachineLogsClient{ClientStream: stream}
...
func (c *managementServiceClient) KubernetesSyncManifests(ctx context.Context, in *KubernetesSyncManifestRequest, opts ...grpc.CallOption) (ManagementService_KubernetesSyncManifestsClient, error) {
	...
	x := &managementServiceKubernetesSyncManifestsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *managementServiceClient) GetSupportBundle(ctx context.Context, in *GetSupportBundleRequest, opts ...grpc.CallOption) (ManagementService_GetSupportBundleClient, error) {
	...
	x := &managementServiceGetSupportBundleClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _ManagementService_MachineLogs_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ManagementServiceServer).MachineLogs(m, &managementServiceMachineLogsServer{ServerStream: stream})
}
...
func _ManagementService_KubernetesSyncManifests_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ManagementServiceServer).KubernetesSyncManifests(m, &managementServiceKubernetesSyncManifestsServer{ServerStream: stream})
}
...
func _ManagementService_GetSupportBundle_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ManagementServiceServer).GetSupportBundle(m, &managementServiceGetSupportBundleServer{ServerStream: stream})
}
