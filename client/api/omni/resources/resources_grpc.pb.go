...
type ResourceServiceClient interface {
	...
	Controllers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ControllersResponse, error)
...
func (c *resourceServiceClient) Controllers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ControllersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ResourceServiceServer interface {
	...
	Controllers(context.Context, *emptypb.Empty) (*ControllersResponse, error)
...
func (UnimplementedResourceServiceServer) Controllers(context.Context, *emptypb.Empty) (*ControllersResponse, error) {
...
func _ResourceService_Controllers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResourceServiceServer).Controllers(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
