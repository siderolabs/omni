...
func (m *MachineDiscoveryServiceConfigSpec) CloneVT() *MachineDiscoveryServiceConfigSpec {
	if m == nil {
		return (*MachineDiscoveryServiceConfigSpec)(nil)
	}
	r := new(MachineDiscoveryServiceConfigSpec)
	r.DiscoveryServiceEndpoint = m.DiscoveryServiceEndpoint
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *MachineDiscoveryServiceConfigSpec) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *MachineDiscoveryServiceConfigSpec) EqualVT(that *MachineDiscoveryServiceConfigSpec) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *MachineDiscoveryServiceConfigSpec) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*MachineDiscoveryServiceConfigSpec)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *MachineDiscoveryServiceConfigSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *MachineDiscoveryServiceConfigSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *MachineDiscoveryServiceConfigSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *MachineDiscoveryServiceConfigSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MachineDiscoveryServiceConfigSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MachineDiscoveryServiceConfigSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MachineDiscoveryServiceConfigSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
