...
func (m *ClusterIdentitySpec) CloneVT() *ClusterIdentitySpec {
	if m == nil {
		return (*ClusterIdentitySpec)(nil)
	}
	r := new(ClusterIdentitySpec)
...
func (m *ClusterIdentitySpec) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *DiscoveryAuditResultSpec) CloneVT() *DiscoveryAuditResultSpec {
	if m == nil {
		return (*DiscoveryAuditResultSpec)(nil)
	}
	r := new(DiscoveryAuditResultSpec)
	r.ClusterId = m.ClusterId
	if rhs := m.DeletedAffiliateIds; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.DeletedAffiliateIds = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *DiscoveryAuditResultSpec) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *ClusterIdentitySpec) EqualVT(that *ClusterIdentitySpec) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *ClusterIdentitySpec) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*ClusterIdentitySpec)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *DiscoveryAuditResultSpec) EqualVT(that *DiscoveryAuditResultSpec) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if len(this.DeletedAffiliateIds) != len(that.DeletedAffiliateIds) {
		return false
	}
	for i, vx := range this.DeletedAffiliateIds {
		vy := that.DeletedAffiliateIds[i]
		if vx != vy {
			return false
		}
	}
...
func (this *DiscoveryAuditResultSpec) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*DiscoveryAuditResultSpec)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *ClusterIdentitySpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ClusterIdentitySpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ClusterIdentitySpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *DiscoveryAuditResultSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *DiscoveryAuditResultSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *DiscoveryAuditResultSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.DeletedAffiliateIds) > 0 {
		for iNdEx := len(m.DeletedAffiliateIds) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.DeletedAffiliateIds[iNdEx])
			copy(dAtA[i:], m.DeletedAffiliateIds[iNdEx])
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.DeletedAffiliateIds[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *ClusterIdentitySpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DiscoveryAuditResultSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.DeletedAffiliateIds) > 0 {
		for _, s := range m.DeletedAffiliateIds {
			l = len(s)
			n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
...
func (m *ClusterIdentitySpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ClusterIdentitySpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ClusterIdentitySpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *DiscoveryAuditResultSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DiscoveryAuditResultSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DiscoveryAuditResultSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeletedAffiliateIds", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DeletedAffiliateIds = append(m.DeletedAffiliateIds, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
