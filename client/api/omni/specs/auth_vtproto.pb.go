...
func (m *AuthConfigSpec_OIDC) CloneVT() *AuthConfigSpec_OIDC {
	if m == nil {
		return (*AuthConfigSpec_OIDC)(nil)
	}
	r := new(AuthConfigSpec_OIDC)
	r.Enabled = m.Enabled
	r.ProviderUrl = m.ProviderUrl
	r.ClientId = m.ClientId
...
func (m *AuthConfigSpec_OIDC) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *AuthConfigSpec_SAML) CloneVT() *AuthConfigSpec_SAML {
	...
	if rhs := m.AttributeRules; rhs != nil {
		tmpContainer := make(map[string]string, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v
		}
		r.AttributeRules = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *IdentityLastActiveSpec) CloneVT() *IdentityLastActiveSpec {
	if m == nil {
		return (*IdentityLastActiveSpec)(nil)
	}
	r := new(IdentityLastActiveSpec)
...
func (m *IdentityLastActiveSpec) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *PublicKeyLastActiveSpec) CloneVT() *PublicKeyLastActiveSpec {
	if m == nil {
		return (*PublicKeyLastActiveSpec)(nil)
	}
	r := new(PublicKeyLastActiveSpec)
...
func (m *PublicKeyLastActiveSpec) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *IdentityStatusSpec) CloneVT() *IdentityStatusSpec {
	if m == nil {
		return (*IdentityStatusSpec)(nil)
	}
	r := new(IdentityStatusSpec)
	r.UserId = m.UserId
	r.Role = m.Role
...
func (m *IdentityStatusSpec) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *RoleSpec_Rule) CloneVT() *RoleSpec_Rule {
	if m == nil {
		return (*RoleSpec_Rule)(nil)
	}
	r := new(RoleSpec_Rule)
	...
	if rhs := m.KubernetesGroups; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.KubernetesGroups = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *RoleSpec_Rule) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *RoleSpec) CloneVT() *RoleSpec {
	...
	r := new(RoleSpec)
	if rhs := m.Rules; rhs != nil {
		tmpContainer := make([]*RoleSpec_Rule, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.Rules = tmpContainer
...
func (m *RoleBindingSpec_Subject) CloneVT() *RoleBindingSpec_Subject {
	if m == nil {
		return (*RoleBindingSpec_Subject)(nil)
	}
	r := new(RoleBindingSpec_Subject)
	r.Name = m.Name
	r.Match = m.Match
	if rhs := m.LabelSelectors; rhs != nil {
		tmpContainer := make([]string, len(rhs))
...
func (m *RoleBindingSpec_Subject) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *RoleBindingSpec) CloneVT() *RoleBindingSpec {
	...
	if rhs := m.Subjects; rhs != nil {
		tmpContainer := make([]*RoleBindingSpec_Subject, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
...
func (m *ServiceAccountStatusSpec_PgpPublicKey) CloneVT() *ServiceAccountStatusSpec_PgpPublicKey {
	if m == nil {
		return (*ServiceAccountStatusSpec_PgpPublicKey)(nil)
	}
	r := new(ServiceAccountStatusSpec_PgpPublicKey)
	r.Id = m.Id
	r.Armored = m.Armored
	r.Expiration = (*timestamppb.Timestamp)((*timestamppb1.Timestamp)(m.Expiration).CloneVT())
...
func (m *ServiceAccountStatusSpec_PgpPublicKey) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *ServiceAccountStatusSpec) CloneVT() *ServiceAccountStatusSpec {
	if m == nil {
		return (*ServiceAccountStatusSpec)(nil)
	}
...
func (m *ServiceAccountStatusSpec) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *EulaAcceptanceSpec) CloneVT() *EulaAcceptanceSpec {
	if m == nil {
		return (*EulaAcceptanceSpec)(nil)
	}
	r := new(EulaAcceptanceSpec)
	r.AcceptedByName = m.AcceptedByName
	r.AcceptedByEmail = m.AcceptedByEmail
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *EulaAcceptanceSpec) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *AuthConfigSpec_OIDC) EqualVT(that *AuthConfigSpec_OIDC) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if this.ProviderUrl != that.ProviderUrl {
		return false
	}
	if this.ClientId != that.ClientId {
		return false
...
func (this *AuthConfigSpec_OIDC) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*AuthConfigSpec_OIDC)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *AuthConfigSpec_SAML) EqualVT(that *AuthConfigSpec_SAML) bool {
	...
	if len(this.AttributeRules) != len(that.AttributeRules) {
		return false
	}
	for i, vx := range this.AttributeRules {
		vy, ok := that.AttributeRules[i]
		if !ok {
			return false
		}
		if vx != vy {
...
func (this *IdentityLastActiveSpec) EqualVT(that *IdentityLastActiveSpec) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *IdentityLastActiveSpec) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*IdentityLastActiveSpec)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *PublicKeyLastActiveSpec) EqualVT(that *PublicKeyLastActiveSpec) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *PublicKeyLastActiveSpec) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*PublicKeyLastActiveSpec)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *IdentityStatusSpec) EqualVT(that *IdentityStatusSpec) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *IdentityStatusSpec) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*IdentityStatusSpec)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *RoleSpec_Rule) EqualVT(that *RoleSpec_Rule) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if len(this.KubernetesGroups) != len(that.KubernetesGroups) {
		return false
	}
	for i, vx := range this.KubernetesGroups {
		vy := that.KubernetesGroups[i]
		if vx != vy {
			return false
		}
	}
...
func (this *RoleSpec_Rule) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*RoleSpec_Rule)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *RoleBindingSpec_Subject) EqualVT(that *RoleBindingSpec_Subject) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *RoleBindingSpec_Subject) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*RoleBindingSpec_Subject)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *RoleBindingSpec) EqualVT(that *RoleBindingSpec) bool {
	...
	for i, vx := range this.Subjects {
		...
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &RoleBindingSpec_Subject{}
			}
			if q == nil {
				q = &RoleBindingSpec_Subject{}
			}
			if !p.EqualVT(q) {
				return false
			}
...
func (this *ServiceAccountStatusSpec_PgpPublicKey) EqualVT(that *ServiceAccountStatusSpec_PgpPublicKey) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *ServiceAccountStatusSpec_PgpPublicKey) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*ServiceAccountStatusSpec_PgpPublicKey)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *ServiceAccountStatusSpec) EqualVT(that *ServiceAccountStatusSpec) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	for i, vx := range this.PublicKeys {
		...
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &ServiceAccountStatusSpec_PgpPublicKey{}
			}
			if q == nil {
				q = &ServiceAccountStatusSpec_PgpPublicKey{}
			}
			if !p.EqualVT(q) {
				return false
			}
...
func (this *ServiceAccountStatusSpec) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*ServiceAccountStatusSpec)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *EulaAcceptanceSpec) EqualVT(that *EulaAcceptanceSpec) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	}
	if this.AcceptedByName != that.AcceptedByName {
		return false
	}
	if this.AcceptedByEmail != that.AcceptedByEmail {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}

func (this *EulaAcceptanceSpec) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*EulaAcceptanceSpec)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *AuthConfigSpec_OIDC) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *AuthConfigSpec_OIDC) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *AuthConfigSpec_OIDC) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.ProviderUrl) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ProviderUrl)))
		i--
		dAtA[i] = 0x12
	}
	if m.Enabled {
...
func (m *AuthConfigSpec_SAML) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.AttributeRules) > 0 {
		for k := range m.AttributeRules {
			v := m.AttributeRules[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
...
func (m *IdentityLastActiveSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *IdentityLastActiveSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *IdentityLastActiveSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *PublicKeyLastActiveSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *PublicKeyLastActiveSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PublicKeyLastActiveSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *IdentityStatusSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *IdentityStatusSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *IdentityStatusSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *RoleSpec_Rule) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *RoleSpec_Rule) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *RoleSpec_Rule) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.KubernetesGroups) > 0 {
		for iNdEx := len(m.KubernetesGroups) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.KubernetesGroups[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
	...
	if len(m.Verbs) > 0 {
		for iNdEx := len(m.Verbs) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Verbs[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *RoleBindingSpec_Subject) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *RoleBindingSpec_Subject) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *RoleBindingSpec_Subject) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *RoleBindingSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.RoleRef) > 0 {
		i -= len(m.RoleRef)
		copy(dAtA[i:], m.RoleRef)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.RoleRef)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ServiceAccountStatusSpec_PgpPublicKey) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ServiceAccountStatusSpec_PgpPublicKey) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ServiceAccountStatusSpec_PgpPublicKey) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *ServiceAccountStatusSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ServiceAccountStatusSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ServiceAccountStatusSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *EulaAcceptanceSpec) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *EulaAcceptanceSpec) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *EulaAcceptanceSpec) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.AcceptedByEmail) > 0 {
		i -= len(m.AcceptedByEmail)
		copy(dAtA[i:], m.AcceptedByEmail)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.AcceptedByEmail)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.AcceptedByName) > 0 {
		i -= len(m.AcceptedByName)
		copy(dAtA[i:], m.AcceptedByName)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.AcceptedByName)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *AuthConfigSpec_OIDC) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AuthConfigSpec_SAML) SizeVT() (n int) {
	...
	if len(m.AttributeRules) > 0 {
		for k, v := range m.AttributeRules {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + protohelpers.SizeOfVarint(uint64(len(k))) + 1 + len(v) + protohelpers.SizeOfVarint(uint64(len(v)))
			n += mapEntrySize + 1 + protohelpers.SizeOfVarint(uint64(mapEntrySize))
...
func (m *IdentityLastActiveSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PublicKeyLastActiveSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *IdentityStatusSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RoleSpec_Rule) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RoleBindingSpec_Subject) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ServiceAccountStatusSpec_PgpPublicKey) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ServiceAccountStatusSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EulaAcceptanceSpec) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = len(m.AcceptedByName)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	l = len(m.AcceptedByEmail)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
...
func (m *AuthConfigSpec_OIDC) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AuthConfigSpec_OIDC: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AuthConfigSpec_OIDC: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *AuthConfigSpec_SAML) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AttributeRules", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AttributeRules == nil {
				m.AttributeRules = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.AttributeRules[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
...
func (m *AuthConfigSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.Oidc == nil {
				m.Oidc = &AuthConfigSpec_OIDC{}
			}
			if err := m.Oidc.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *IdentityLastActiveSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IdentityLastActiveSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IdentityLastActiveSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *PublicKeyLastActiveSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PublicKeyLastActiveSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PublicKeyLastActiveSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *IdentityStatusSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IdentityStatusSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IdentityStatusSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RoleSpec_Rule) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RoleSpec_Rule: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RoleSpec_Rule: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RoleSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Rules = append(m.Rules, &RoleSpec_Rule{})
			if err := m.Rules[len(m.Rules)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *RoleBindingSpec_Subject) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RoleBindingSpec_Subject: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RoleBindingSpec_Subject: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RoleBindingSpec) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.RoleRef = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.Subjects = append(m.Subjects, &RoleBindingSpec_Subject{})
...
func (m *ServiceAccountStatusSpec_PgpPublicKey) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ServiceAccountStatusSpec_PgpPublicKey: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ServiceAccountStatusSpec_PgpPublicKey: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ServiceAccountStatusSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ServiceAccountStatusSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ServiceAccountStatusSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *EulaAcceptanceSpec) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EulaAcceptanceSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EulaAcceptanceSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AcceptedByName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AcceptedByName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AcceptedByEmail", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AcceptedByEmail = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
