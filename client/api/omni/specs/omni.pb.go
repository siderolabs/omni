...
type ClusterMachineConfigSpec struct {
	...
	ExtraKernelArgs []string `protobuf:"bytes,5,rep,name=extra_kernel_args,json=extraKernelArgs,proto3" json:"extra_kernel_args,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_omni_specs_omni_proto_rawDesc = "" +
	...
	"\fschematic_id\x18\x02 \x01(\tR\vschematicId\"\xe6\x01\n" +
	...
	"\x11extra_kernel_args\x18\x05 \x03(\tR\x0fextraKernelArgs\"_\n" +
...
var file_omni_specs_omni_proto_msgTypes = make([]protoimpl.MessageInfo, 126)
var file_omni_specs_omni_proto_goTypes = []any{
	...
	(*MachineStatusSpec_HardwareStatus)(nil),                  // 115: specs.MachineStatusSpec.HardwareStatus
	(*MachineStatusSpec_NetworkStatus)(nil),                   // 116: specs.MachineStatusSpec.NetworkStatus
	(*MachineStatusSpec_PlatformMetadata)(nil),                // 117: specs.MachineStatusSpec.PlatformMetadata
	(*MachineStatusSpec_Schematic)(nil),                       // 118: specs.MachineStatusSpec.Schematic
	(*MachineStatusSpec_Diagnostic)(nil),                      // 119: specs.MachineStatusSpec.Diagnostic
	nil,                                                       // 120: specs.MachineStatusSpec.ImageLabelsEntry
	(*MachineStatusSpec_HardwareStatus_Processor)(nil),        // 121: specs.MachineStatusSpec.HardwareStatus.Processor
	(*MachineStatusSpec_HardwareStatus_MemoryModule)(nil),     // 122: specs.MachineStatusSpec.HardwareStatus.MemoryModule
	(*MachineStatusSpec_HardwareStatus_BlockDevice)(nil),      // 123: specs.MachineStatusSpec.HardwareStatus.BlockDevice
	(*MachineStatusSpec_NetworkStatus_NetworkLinkStatus)(nil), // 124: specs.MachineStatusSpec.NetworkStatus.NetworkLinkStatus
	(*MachineStatusSpec_Schematic_InitialState)(nil),          // 125: specs.MachineStatusSpec.Schematic.InitialState
	(*ClusterSpec_Features)(nil),                              // 126: specs.ClusterSpec.Features
	(*ClusterMachineStatusSpec_ProvisionStatus)(nil),          // 127: specs.ClusterMachineStatusSpec.ProvisionStatus
	(*MachineSetSpec_MachineClass)(nil),                       // 128: specs.MachineSetSpec.MachineClass
	(*MachineSetSpec_MachineAllocation)(nil),                  // 129: specs.MachineSetSpec.MachineAllocation
	(*MachineSetSpec_BootstrapSpec)(nil),                      // 130: specs.MachineSetSpec.BootstrapSpec
	(*MachineSetSpec_RollingUpdateStrategyConfig)(nil),        // 131: specs.MachineSetSpec.RollingUpdateStrategyConfig
	(*MachineSetSpec_UpdateStrategyConfig)(nil),               // 132: specs.MachineSetSpec.UpdateStrategyConfig
	(*ControlPlaneStatusSpec_Condition)(nil),                  // 133: specs.ControlPlaneStatusSpec.Condition
	(*KubernetesStatusSpec_NodeStatus)(nil),                   // 134: specs.KubernetesStatusSpec.NodeStatus
	(*KubernetesStatusSpec_StaticPodStatus)(nil),              // 135: specs.KubernetesStatusSpec.StaticPodStatus
	(*KubernetesStatusSpec_NodeStaticPods)(nil),               // 136: specs.KubernetesStatusSpec.NodeStaticPods
	(*MachineClassSpec_Provision)(nil),                        // 137: specs.MachineClassSpec.Provision
	(*MachineConfigGenOptionsSpec_InstallImage)(nil),          // 138: specs.MachineConfigGenOptionsSpec.InstallImage
	(*KubernetesUsageSpec_Quantity)(nil),                      // 139: specs.KubernetesUsageSpec.Quantity
	(*KubernetesUsageSpec_Pod)(nil),                           // 140: specs.KubernetesUsageSpec.Pod
	(*ImagePullRequestSpec_NodeImageList)(nil),                // 141: specs.ImagePullRequestSpec.NodeImageList
	(*TalosExtensionsSpec_Info)(nil),                          // 142: specs.TalosExtensionsSpec.Info
	(*MachineExtensionsStatusSpec_Item)(nil),                  // 143: specs.MachineExtensionsStatusSpec.Item
	nil,                                                       // 144: specs.ClusterStatusMetricsSpec.PhasesEntry
	(*ClusterDiagnosticsSpec_Node)(nil),                       // 145: specs.ClusterDiagnosticsSpec.Node
	(*InfraMachineBMCConfigSpec_IPMI)(nil),                    // 146: specs.InfraMachineBMCConfigSpec.IPMI
	(*InfraMachineBMCConfigSpec_API)(nil),                     // 147: specs.InfraMachineBMCConfigSpec.API
	(*InfraProviderCombinedStatusSpec_Health)(nil),            // 148: specs.InfraProviderCombinedStatusSpec.Health
	(*durationpb.Duration)(nil),                               // 149: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),                             // 150: google.protobuf.Timestamp
	(*machine.MachineStatusEvent)(nil),                        // 151: machine.MachineStatusEvent
}
var file_omni_specs_omni_proto_depIdxs = []int32{
	...
	116, // 1: specs.MachineStatusSpec.network:type_name -> specs.MachineStatusSpec.NetworkStatus
	4,   // 2: specs.MachineStatusSpec.role:type_name -> specs.MachineStatusSpec.Role
	117, // 3: specs.MachineStatusSpec.platform_metadata:type_name -> specs.MachineStatusSpec.PlatformMetadata
	120, // 4: specs.MachineStatusSpec.image_labels:type_name -> specs.MachineStatusSpec.ImageLabelsEntry
	118, // 5: specs.MachineStatusSpec.schematic:type_name -> specs.MachineStatusSpec.Schematic
	119, // 6: specs.MachineStatusSpec.diagnostics:type_name -> specs.MachineStatusSpec.Diagnostic
	...
	126, // 9: specs.ClusterSpec.features:type_name -> specs.ClusterSpec.Features
	31,  // 10: specs.ClusterSpec.backup_configuration:type_name -> specs.EtcdBackupConf
	149, // 11: specs.EtcdBackupConf.interval:type_name -> google.protobuf.Duration
	150, // 12: specs.EtcdBackupSpec.created_at:type_name -> google.protobuf.Timestamp
	149, // 13: specs.BackupDataSpec.interval:type_name -> google.protobuf.Duration
	6,   // 14: specs.EtcdBackupStatusSpec.status:type_name -> specs.EtcdBackupStatusSpec.Status
	150, // 15: specs.EtcdBackupStatusSpec.last_backup_time:type_name -> google.protobuf.Timestamp
	150, // 16: specs.EtcdBackupStatusSpec.last_backup_attempt:type_name -> google.protobuf.Timestamp
	150, // 17: specs.EtcdManualBackupSpec.backup_at:type_name -> google.protobuf.Timestamp
	...
	127, // 21: specs.ClusterMachineStatusSpec.provision_status:type_name -> specs.ClusterMachineStatusSpec.ProvisionStatus
	...
	129, // 25: specs.MachineSetSpec.machine_class:type_name -> specs.MachineSetSpec.MachineAllocation
	130, // 26: specs.MachineSetSpec.bootstrap_spec:type_name -> specs.MachineSetSpec.BootstrapSpec
	9,   // 27: specs.MachineSetSpec.delete_strategy:type_name -> specs.MachineSetSpec.UpdateStrategy
	132, // 28: specs.MachineSetSpec.update_strategy_config:type_name -> specs.MachineSetSpec.UpdateStrategyConfig
	132, // 29: specs.MachineSetSpec.delete_strategy_config:type_name -> specs.MachineSetSpec.UpdateStrategyConfig
	129, // 30: specs.MachineSetSpec.machine_allocation:type_name -> specs.MachineSetSpec.MachineAllocation
	...
	129, // 34: specs.MachineSetStatusSpec.machine_allocation:type_name -> specs.MachineSetSpec.MachineAllocation
	151, // 35: specs.MachineStatusSnapshotSpec.machine_status:type_name -> machine.MachineStatusEvent
	13,  // 36: specs.MachineStatusSnapshotSpec.power_stage:type_name -> specs.MachineStatusSnapshotSpec.PowerStage
	133, // 37: specs.ControlPlaneStatusSpec.conditions:type_name -> specs.ControlPlaneStatusSpec.Condition
	134, // 38: specs.KubernetesStatusSpec.nodes:type_name -> specs.KubernetesStatusSpec.NodeStatus
	136, // 39: specs.KubernetesStatusSpec.static_pods:type_name -> specs.KubernetesStatusSpec.NodeStaticPods
	...
	149, // 46: specs.EtcdBackupSettings.tick_interval:type_name -> google.protobuf.Duration
	149, // 47: specs.EtcdBackupSettings.min_interval:type_name -> google.protobuf.Duration
	149, // 48: specs.EtcdBackupSettings.max_interval:type_name -> google.protobuf.Duration
	137, // 49: specs.MachineClassSpec.auto_provision:type_name -> specs.MachineClassSpec.Provision
	138, // 50: specs.MachineConfigGenOptionsSpec.install_image:type_name -> specs.MachineConfigGenOptionsSpec.InstallImage
	139, // 51: specs.KubernetesUsageSpec.cpu:type_name -> specs.KubernetesUsageSpec.Quantity
	139, // 52: specs.KubernetesUsageSpec.mem:type_name -> specs.KubernetesUsageSpec.Quantity
	139, // 53: specs.KubernetesUsageSpec.storage:type_name -> specs.KubernetesUsageSpec.Quantity
	140, // 54: specs.KubernetesUsageSpec.pods:type_name -> specs.KubernetesUsageSpec.Pod
	141, // 55: specs.ImagePullRequestSpec.node_image_list:type_name -> specs.ImagePullRequestSpec.NodeImageList
	142, // 56: specs.TalosExtensionsSpec.items:type_name -> specs.TalosExtensionsSpec.Info
	17,  // 57: specs.ExtensionsConfigurationStatusSpec.phase:type_name -> specs.ExtensionsConfigurationStatusSpec.Phase
	143, // 58: specs.MachineExtensionsStatusSpec.extensions:type_name -> specs.MachineExtensionsStatusSpec.Item
	19,  // 59: specs.MachineExtraKernelArgsStatusSpec.phase:type_name -> specs.MachineExtraKernelArgsStatusSpec.Phase
	144, // 60: specs.ClusterStatusMetricsSpec.phases:type_name -> specs.ClusterStatusMetricsSpec.PhasesEntry
	26,  // 61: specs.MachineRequestSetSpec.meta_values:type_name -> specs.MetaValue
	3,   // 62: specs.MachineRequestSetSpec.grpc_tunnel:type_name -> specs.GrpcTunnelMode
	145, // 63: specs.ClusterDiagnosticsSpec.nodes:type_name -> specs.ClusterDiagnosticsSpec.Node
	20,  // 64: specs.ClusterMachineRequestStatusSpec.stage:type_name -> specs.ClusterMachineRequestStatusSpec.Stage
	22,  // 65: specs.InfraMachineConfigSpec.power_state:type_name -> specs.InfraMachineConfigSpec.MachinePowerState
	21,  // 66: specs.InfraMachineConfigSpec.acceptance_status:type_name -> specs.InfraMachineConfigSpec.AcceptanceStatus
	146, // 67: specs.InfraMachineBMCConfigSpec.ipmi:type_name -> specs.InfraMachineBMCConfigSpec.IPMI
	147, // 68: specs.InfraMachineBMCConfigSpec.api:type_name -> specs.InfraMachineBMCConfigSpec.API
	148, // 69: specs.InfraProviderCombinedStatusSpec.health:type_name -> specs.InfraProviderCombinedStatusSpec.Health
	121, // 70: specs.MachineStatusSpec.HardwareStatus.processors:type_name -> specs.MachineStatusSpec.HardwareStatus.Processor
	122, // 71: specs.MachineStatusSpec.HardwareStatus.memory_modules:type_name -> specs.MachineStatusSpec.HardwareStatus.MemoryModule
	123, // 72: specs.MachineStatusSpec.HardwareStatus.blockdevices:type_name -> specs.MachineStatusSpec.HardwareStatus.BlockDevice
	124, // 73: specs.MachineStatusSpec.NetworkStatus.network_links:type_name -> specs.MachineStatusSpec.NetworkStatus.NetworkLinkStatus
	25,  // 74: specs.MachineStatusSpec.Schematic.overlay:type_name -> specs.Overlay
	26,  // 75: specs.MachineStatusSpec.Schematic.meta_values:type_name -> specs.MetaValue
	125, // 76: specs.MachineStatusSpec.Schematic.initial_state:type_name -> specs.MachineStatusSpec.Schematic.InitialState
	...
	131, // 79: specs.MachineSetSpec.UpdateStrategyConfig.rolling:type_name -> specs.MachineSetSpec.RollingUpdateStrategyConfig
	...
	135, // 83: specs.KubernetesStatusSpec.NodeStaticPods.static_pods:type_name -> specs.KubernetesStatusSpec.StaticPodStatus
	26,  // 84: specs.MachineClassSpec.Provision.meta_values:type_name -> specs.MetaValue
	3,   // 85: specs.MachineClassSpec.Provision.grpc_tunnel:type_name -> specs.GrpcTunnelMode
	24,  // 86: specs.MachineConfigGenOptionsSpec.InstallImage.security_state:type_name -> specs.SecurityState
	18,  // 87: specs.MachineExtensionsStatusSpec.Item.phase:type_name -> specs.MachineExtensionsStatusSpec.Item.Phase
