...
import (
	...
	management "github.com/siderolabs/omni/client/api/omni/management"
)
...
const (
	...
	MachineSetPhase_Upgrading     MachineSetPhase = 7
)
...
// FIPSState describes the FIPS state of the machine.
type SecurityState_FIPSState int32

const (
	SecurityState_FIPS_STATE_DISABLED SecurityState_FIPSState = 0
	SecurityState_FIPS_STATE_ENABLED  SecurityState_FIPSState = 1
	SecurityState_FIPS_STATE_STRICT   SecurityState_FIPSState = 2
)

// Enum value maps for SecurityState_FIPSState.
var (
	SecurityState_FIPSState_name = map[int32]string{
		0: "FIPS_STATE_DISABLED",
		1: "FIPS_STATE_ENABLED",
		2: "FIPS_STATE_STRICT",
	}
	SecurityState_FIPSState_value = map[string]int32{
...
func (x SecurityState_FIPSState) Enum() *SecurityState_FIPSState {
	p := new(SecurityState_FIPSState)
	*p = x
	return p
}

func (x SecurityState_FIPSState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SecurityState_FIPSState) Descriptor() protoreflect.EnumDescriptor {
	return file_omni_specs_omni_proto_enumTypes[4].Descriptor()
}

func (SecurityState_FIPSState) Type() protoreflect.EnumType {
	return &file_omni_specs_omni_proto_enumTypes[4]
}

func (x SecurityState_FIPSState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SecurityState_FIPSState.Descriptor instead.
func (SecurityState_FIPSState) EnumDescriptor() ([]byte, []int) {
...
func (ClusterStatusSpec_Phase) EnumDescriptor() ([]byte, []int) {
	return file_omni_specs_omni_proto_rawDescGZIP(), []int{26, 0}
}
...
const (
	SecretRotationSpec_IDLE        SecretRotationSpec_Status = 0
	SecretRotationSpec_IN_PROGRESS SecretRotationSpec_Status = 1
)

// Enum value maps for SecretRotationSpec_Status.
var (
	SecretRotationSpec_Status_name = map[int32]string{
		0: "IDLE",
		1: "IN_PROGRESS",
	}
	SecretRotationSpec_Status_value = map[string]int32{
		"IDLE":        0,
		"IN_PROGRESS": 1,
	}
)

func (x SecretRotationSpec_Status) Enum() *SecretRotationSpec_Status {
	p := new(SecretRotationSpec_Status)
	*p = x
	return p
}

func (x SecretRotationSpec_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SecretRotationSpec_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_omni_specs_omni_proto_enumTypes[23].Descriptor()
}

func (SecretRotationSpec_Status) Type() protoreflect.EnumType {
	return &file_omni_specs_omni_proto_enumTypes[23]
}

func (x SecretRotationSpec_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
const (
	SecretRotationSpec_OK          SecretRotationSpec_Phase = 0
	SecretRotationSpec_PRE_ROTATE  SecretRotationSpec_Phase = 1
	SecretRotationSpec_ROTATE      SecretRotationSpec_Phase = 2
	SecretRotationSpec_POST_ROTATE SecretRotationSpec_Phase = 3
)

// Enum value maps for SecretRotationSpec_Phase.
var (
	SecretRotationSpec_Phase_name = map[int32]string{
		0: "OK",
		1: "PRE_ROTATE",
		2: "ROTATE",
		3: "POST_ROTATE",
	}
	SecretRotationSpec_Phase_value = map[string]int32{
		"OK":          0,
		"PRE_ROTATE":  1,
		"ROTATE":      2,
		"POST_ROTATE": 3,
...
func (x SecretRotationSpec_Phase) Enum() *SecretRotationSpec_Phase {
	p := new(SecretRotationSpec_Phase)
	*p = x
	return p
}

func (x SecretRotationSpec_Phase) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SecretRotationSpec_Phase) Descriptor() protoreflect.EnumDescriptor {
	return file_omni_specs_omni_proto_enumTypes[24].Descriptor()
}

func (SecretRotationSpec_Phase) Type() protoreflect.EnumType {
	return &file_omni_specs_omni_proto_enumTypes[24]
}

func (x SecretRotationSpec_Phase) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
const (
	SecretRotationSpec_NONE          SecretRotationSpec_Component = 0
	SecretRotationSpec_TALOS_CA      SecretRotationSpec_Component = 1
	SecretRotationSpec_KUBERNETES_CA SecretRotationSpec_Component = 2
)

// Enum value maps for SecretRotationSpec_Component.
var (
	SecretRotationSpec_Component_name = map[int32]string{
		0: "NONE",
		1: "TALOS_CA",
		2: "KUBERNETES_CA",
	}
	SecretRotationSpec_Component_value = map[string]int32{
		"NONE":          0,
		"TALOS_CA":      1,
		"KUBERNETES_CA": 2,
	}
...
func (x SecretRotationSpec_Component) Enum() *SecretRotationSpec_Component {
	p := new(SecretRotationSpec_Component)
	*p = x
	return p
}

func (x SecretRotationSpec_Component) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SecretRotationSpec_Component) Descriptor() protoreflect.EnumDescriptor {
	return file_omni_specs_omni_proto_enumTypes[25].Descriptor()
}

func (SecretRotationSpec_Component) Type() protoreflect.EnumType {
	return &file_omni_specs_omni_proto_enumTypes[25]
}

func (x SecretRotationSpec_Component) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
type NotificationSpec_Type int32

const (
	NotificationSpec_INFO    NotificationSpec_Type = 0
	NotificationSpec_WARNING NotificationSpec_Type = 1
	NotificationSpec_ERROR   NotificationSpec_Type = 2
)

// Enum value maps for NotificationSpec_Type.
var (
	NotificationSpec_Type_name = map[int32]string{
		0: "INFO",
		1: "WARNING",
		2: "ERROR",
	}
	NotificationSpec_Type_value = map[string]int32{
		"INFO":    0,
		"WARNING": 1,
		"ERROR":   2,
	}
...
func (x NotificationSpec_Type) Enum() *NotificationSpec_Type {
	p := new(NotificationSpec_Type)
	*p = x
	return p
}

func (x NotificationSpec_Type) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (NotificationSpec_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_omni_specs_omni_proto_enumTypes[26].Descriptor()
}

func (NotificationSpec_Type) Type() protoreflect.EnumType {
	return &file_omni_specs_omni_proto_enumTypes[26]
}

func (x NotificationSpec_Type) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
const (
	KubernetesManifestGroupSpec_UNKNOWN  KubernetesManifestGroupSpec_Mode = 0
	KubernetesManifestGroupSpec_FULL     KubernetesManifestGroupSpec_Mode = 1
	KubernetesManifestGroupSpec_ONE_TIME KubernetesManifestGroupSpec_Mode = 2
)

// Enum value maps for KubernetesManifestGroupSpec_Mode.
var (
	KubernetesManifestGroupSpec_Mode_name = map[int32]string{
		0: "UNKNOWN",
		1: "FULL",
		2: "ONE_TIME",
	}
	KubernetesManifestGroupSpec_Mode_value = map[string]int32{
		"UNKNOWN":  0,
		"FULL":     1,
		"ONE_TIME": 2,
	}
...
func (x KubernetesManifestGroupSpec_Mode) Enum() *KubernetesManifestGroupSpec_Mode {
	p := new(KubernetesManifestGroupSpec_Mode)
	*p = x
	return p
}

func (x KubernetesManifestGroupSpec_Mode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (KubernetesManifestGroupSpec_Mode) Descriptor() protoreflect.EnumDescriptor {
	return file_omni_specs_omni_proto_enumTypes[27].Descriptor()
}

func (KubernetesManifestGroupSpec_Mode) Type() protoreflect.EnumType {
	return &file_omni_specs_omni_proto_enumTypes[27]
}

func (x KubernetesManifestGroupSpec_Mode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
const (
	...
	ClusterKubernetesManifestsStatusSpec_ManifestStatus_APPLIED  ClusterKubernetesManifestsStatusSpec_ManifestStatus_Phase = 2
	ClusterKubernetesManifestsStatusSpec_ManifestStatus_DELETING ClusterKubernetesManifestsStatusSpec_ManifestStatus_Phase = 3
)
...
func (ClusterKubernetesManifestsStatusSpec_ManifestStatus_Phase) Descriptor() protoreflect.EnumDescriptor {
	return file_omni_specs_omni_proto_enumTypes[28].Descriptor()
}

func (ClusterKubernetesManifestsStatusSpec_ManifestStatus_Phase) Type() protoreflect.EnumType {
	return &file_omni_specs_omni_proto_enumTypes[28]
}
...
const (
	ClusterKubernetesManifestsStatusSpec_GroupStatus_UNKNOWN     ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase = 0
	ClusterKubernetesManifestsStatusSpec_GroupStatus_PENDING     ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase = 1
	ClusterKubernetesManifestsStatusSpec_GroupStatus_PROGRESSING ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase = 2
	ClusterKubernetesManifestsStatusSpec_GroupStatus_APPLIED     ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase = 3
	ClusterKubernetesManifestsStatusSpec_GroupStatus_DELETING    ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase = 4
)

// Enum value maps for ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase.
var (
	ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase_name = map[int32]string{
		0: "UNKNOWN",
		1: "PENDING",
		2: "PROGRESSING",
		3: "APPLIED",
	...
	ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase_value = map[string]int32{
		"UNKNOWN":     0,
		"PENDING":     1,
		"PROGRESSING": 2,
		"APPLIED":     3,
...
func (x ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase) Enum() *ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase {
	p := new(ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase)
	*p = x
	return p
}

func (x ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase) Descriptor() protoreflect.EnumDescriptor {
	return file_omni_specs_omni_proto_enumTypes[29].Descriptor()
}

func (ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase) Type() protoreflect.EnumType {
	return &file_omni_specs_omni_proto_enumTypes[29]
}

func (x ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
// SecurityState describes the security state of the machine: UKI, secure boot and FIPS information.
type SecurityState struct {
	...
	// FipsState is the FIPS state reported by the machine.
	FipsState     SecurityState_FIPSState `protobuf:"varint,3,opt,name=fips_state,json=fipsState,proto3,enum=specs.SecurityState_FIPSState" json:"fips_state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SecurityState) GetFipsState() SecurityState_FIPSState {
	if x != nil {
		return x.FipsState
	}
	return SecurityState_FIPS_STATE_DISABLED
}
...
type MachineStatusSpec struct {
	...
	// TalosVersionName is the Talos version name reported by the machine, e.g. "Talos Enterprise".
	TalosVersionName string `protobuf:"bytes,23,opt,name=talos_version_name,json=talosVersionName,proto3" json:"talos_version_name,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *MachineStatusSpec) GetTalosVersionName() string {
	if x != nil {
		return x.TalosVersionName
	}
	return ""
}
...
type ClusterMachineConfigSpec struct {
	...
	// InstallDisk is the install disk this config was generated for.
	//
	// It is checked against the machine's install disk selection at generation time, and the
	// install uses this value. The config data cannot carry a different disk, because config
	// patches setting the disk are rejected, and the ones created before that restriction are
	// overridden at generation time. It is empty only on configs generated by older Omni versions.
...
func (x *ClusterMachineConfigSpec) GetInstallDisk() string {
	if x != nil {
...
type ClusterMachineConfigStatusSpec struct {
	...
	// RedactedClusterMachineConfig contains the config bytes. It is only set if the config is not compressed. Otherwise, CompressedData is set instead.
	//
	// Deprecated: use accessor methods GetUncompressedData/SetUncompressedData to manage this field.
	RedactedCurrentMachineConfig string `protobuf:"bytes,9,opt,name=redacted_current_machine_config,json=redactedCurrentMachineConfig,proto3" json:"redacted_current_machine_config,omitempty"`
	// CompressedRedactedMachineConfig contains the config bytes. It is only set if the config is not compressed. Otherwise, CompressedData is set instead.
	//
	// Deprecated: use accessor methods GetUncompressedData/SetUncompressedData to manage this field.
...
func (x *ClusterMachineConfigStatusSpec) GetRedactedCurrentMachineConfig() string {
	if x != nil {
		return x.RedactedCurrentMachineConfig
	}
	return ""
}

func (x *ClusterMachineConfigStatusSpec) GetCompressedRedactedMachineConfig() []byte {
	if x != nil {
...
func (x *ClusterMachineConfigStatusSpec) GetImageFactoryHost() string {
	if x != nil {
...
func (x *MachinePendingUpdatesSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MachinePendingUpdatesSpec) GetConfigDiff() string {
	if x != nil {
		return x.ConfigDiff
	}
	return ""
...
type ClusterSecretsSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Data holds serialized cluster secrets.
	Data []byte `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	...
	// Extra_certs holds extra cluster CAs to be used during CA rotation.
	ExtraCerts    *ClusterSecretsSpec_Certs `protobuf:"bytes,3,opt,name=extra_certs,json=extraCerts,proto3" json:"extra_certs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ClusterSecretsSpec) GetExtraCerts() *ClusterSecretsSpec_Certs {
	if x != nil {
		return x.ExtraCerts
	}
	return nil
...
type MachineSetSpec struct {
	...
	// UpgradeStrategy defines the upgrade strategy of the machine set.
	UpgradeStrategy MachineSetSpec_UpdateStrategy `protobuf:"varint,8,opt,name=upgrade_strategy,json=upgradeStrategy,proto3,enum=specs.MachineSetSpec_UpdateStrategy" json:"upgrade_strategy,omitempty"`
	// UpgradeStrategyConfig defines the upgrade strategy configuration.
	UpgradeStrategyConfig *MachineSetSpec_UpdateStrategyConfig `protobuf:"bytes,9,opt,name=upgrade_strategy_config,json=upgradeStrategyConfig,proto3" json:"upgrade_strategy_config,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *MachineSetSpec) GetUpgradeStrategy() MachineSetSpec_UpdateStrategy {
	if x != nil {
...
func (x *MachineSetSpec) GetUpgradeStrategyConfig() *MachineSetSpec_UpdateStrategyConfig {
	if x != nil {
		return x.UpgradeStrategyConfig
	}
	return nil
}
...
// MachineSetConfigStatusSpec is the settings used by the MachineConfigStatus controller:
// - update strategy is copied from the MachineSet
// - config updates allow flag is controller by the MachineSetStatus controller phase.
type MachineSetConfigStatusSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// ConfigUpdatesAllowed controls graceful rollout of the machine config.
	// If false, no new config updates should happen.
	ConfigUpdatesAllowed bool `protobuf:"varint,1,opt,name=config_updates_allowed,json=configUpdatesAllowed,proto3" json:"config_updates_allowed,omitempty"`
	// ShouldResetGraceful controls graceful reset of the machine config.
	ShouldResetGraceful bool `protobuf:"varint,2,opt,name=should_reset_graceful,json=shouldResetGraceful,proto3" json:"should_reset_graceful,omitempty"`
	// UpdateStrategy is the update strategy of the machine set.
	UpdateStrategy MachineSetSpec_UpdateStrategy `protobuf:"varint,3,opt,name=update_strategy,json=updateStrategy,proto3,enum=specs.MachineSetSpec_UpdateStrategy" json:"update_strategy,omitempty"`
	// UpdateStrategyConfig defines the update strategy configuration.
	UpdateStrategyConfig *MachineSetSpec_UpdateStrategyConfig `protobuf:"bytes,4,opt,name=update_strategy_config,json=updateStrategyConfig,proto3" json:"update_strategy_config,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *MachineSetConfigStatusSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MachineSetConfigStatusSpec) GetConfigUpdatesAllowed() bool {
	if x != nil {
		return x.ConfigUpdatesAllowed
	}
	return false
}

func (x *MachineSetConfigStatusSpec) GetShouldResetGraceful() bool {
	if x != nil {
		return x.ShouldResetGraceful
	}
	return false
}

func (x *MachineSetConfigStatusSpec) GetUpdateStrategy() MachineSetSpec_UpdateStrategy {
	if x != nil {
		return x.UpdateStrategy
	}
	return MachineSetSpec_Unset
...
func (x *MachineSetConfigStatusSpec) GetUpdateStrategyConfig() *MachineSetSpec_UpdateStrategyConfig {
	if x != nil {
		return x.UpdateStrategyConfig
	}
	return nil
...
type OngoingTaskSpec struct {
	...
	//	*OngoingTaskSpec_SecretsRotation
...
func (x *OngoingTaskSpec) GetSecretsRotation() *ClusterSecretsRotationStatusSpec {
	if x != nil {
		if x, ok := x.Details.(*OngoingTaskSpec_SecretsRotation); ok {
			return x.SecretsRotation
		}
	}
	return nil
}
...
type OngoingTaskSpec_SecretsRotation struct {
	SecretsRotation *ClusterSecretsRotationStatusSpec `protobuf:"bytes,7,opt,name=secrets_rotation,json=secretsRotation,proto3,oneof"`
}
...
func (*OngoingTaskSpec_SecretsRotation) isOngoingTaskSpec_Details() {}
...
func (x *FeaturesConfigSpec) GetAccount() *Account {
	if x != nil {
		return x.Account
	}
	return nil
...
func (x *FeaturesConfigSpec) GetPosthogSettings() *PosthogSettings {
	if x != nil {
...
func (x *PosthogSettings) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PosthogSettings) GetApiHost() string {
	if x != nil {
		return x.ApiHost
	}
	return ""
...
func (x *MachineStatusMetricsSpec) GetRegisteredMachinesLimit() uint32 {
	if x != nil {
		return x.RegisteredMachinesLimit
	}
	return 0
}

func (x *MachineStatusMetricsSpec) GetRegistrationLimitReached() bool {
	if x != nil {
...
// MachineRequestSetPressureSpec describes an Omni MachineRequestSetPressure resource spec.
...
func (x *MaintenanceConfigStatusSpec) GetLastAppliedConfigHash() string {
	if x != nil {
		return x.LastAppliedConfigHash
	}
	return ""
}
...
func (x *InstallationMediaConfigSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *InstallationMediaConfigSpec) GetKernelArgs() string {
	if x != nil {
		return x.KernelArgs
	}
	return ""
...
func (x *InstallationMediaConfigSpec) GetCloud() *InstallationMediaConfigSpec_Cloud {
	if x != nil {
		return x.Cloud
	}
	return nil
...
func (x *InstallationMediaConfigSpec) GetSbc() *InstallationMediaConfigSpec_SBC {
	if x != nil {
		return x.Sbc
	}
	return nil
...
func (x *InstallationMediaConfigSpec) GetJoinToken() string {
	if x != nil {
		return x.JoinToken
	}
	return ""
...
func (x *InstallationMediaConfigSpec) GetSecureBoot() bool {
	if x != nil {
		return x.SecureBoot
	}
	return false
...
func (x *InstallationMediaConfigSpec) GetGrpcTunnel() GrpcTunnelMode {
	if x != nil {
		return x.GrpcTunnel
	}
	return GrpcTunnelMode_UNSET
...
func (x *InstallationMediaConfigSpec) GetMachineLabels() map[string]string {
	if x != nil {
...
func (x *InstallationMediaConfigSpec) GetBootloader() management.SchematicBootloader {
	if x != nil {
		return x.Bootloader
	}
...
func (x *RotateTalosCASpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type SecretRotationSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Status holds the status of the secrets rotation.
	Status SecretRotationSpec_Status `protobuf:"varint,1,opt,name=status,proto3,enum=specs.SecretRotationSpec_Status" json:"status,omitempty"`
	// Phase of the ongoing secrets rotation.
	Phase SecretRotationSpec_Phase `protobuf:"varint,2,opt,name=phase,proto3,enum=specs.SecretRotationSpec_Phase" json:"phase,omitempty"`
	// Component currently being rotated.
	Component SecretRotationSpec_Component `protobuf:"varint,3,opt,name=component,proto3,enum=specs.SecretRotationSpec_Component" json:"component,omitempty"`
	// Certs holds cluster CAs used during CA rotation.
	Certs *ClusterSecretsSpec_Certs `protobuf:"bytes,4,opt,name=certs,proto3" json:"certs,omitempty"`
	// Extra_certs holds extra cluster CAs to be used during CA rotation.
	ExtraCerts *ClusterSecretsSpec_Certs `protobuf:"bytes,5,opt,name=extra_certs,json=extraCerts,proto3" json:"extra_certs,omitempty"`
	// Backup_certs_os holds backup of the original OS CA certs before rotation started.
	BackupCertsOs []*ClusterSecretsSpec_Certs_CA `protobuf:"bytes,6,rep,name=backup_certs_os,json=backupCertsOs,proto3" json:"backup_certs_os,omitempty"`
	// Backup_certs_k8s holds backup of the original Kubernetes CA certs before rotation started.
	BackupCertsK8S []*ClusterSecretsSpec_Certs_CA `protobuf:"bytes,7,rep,name=backup_certs_k8s,json=backupCertsK8s,proto3" json:"backup_certs_k8s,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *SecretRotationSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SecretRotationSpec) GetStatus() SecretRotationSpec_Status {
	...
	return SecretRotationSpec_IDLE
}

func (x *SecretRotationSpec) GetPhase() SecretRotationSpec_Phase {
	if x != nil {
		return x.Phase
	}
	return SecretRotationSpec_OK
}

func (x *SecretRotationSpec) GetComponent() SecretRotationSpec_Component {
	if x != nil {
		return x.Component
	}
	return SecretRotationSpec_NONE
}

func (x *SecretRotationSpec) GetCerts() *ClusterSecretsSpec_Certs {
	if x != nil {
		return x.Certs
	}
	return nil
...
func (x *SecretRotationSpec) GetExtraCerts() *ClusterSecretsSpec_Certs {
	if x != nil {
		return x.ExtraCerts
	}
	return nil
...
func (x *SecretRotationSpec) GetBackupCertsOs() []*ClusterSecretsSpec_Certs_CA {
	if x != nil {
		return x.BackupCertsOs
	}
	return nil
}

func (x *SecretRotationSpec) GetBackupCertsK8S() []*ClusterSecretsSpec_Certs_CA {
	if x != nil {
		return x.BackupCertsK8S
	}
	return nil
}

// ClusterSecretsRotationStatusSpec contains the status of the cluster secrets rotation process.
type ClusterSecretsRotationStatusSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Phase of the ongoing secrets rotation.
	Phase SecretRotationSpec_Phase `protobuf:"varint,1,opt,name=phase,proto3,enum=specs.SecretRotationSpec_Phase" json:"phase,omitempty"`
	// Component currently being rotated.
	Component SecretRotationSpec_Component `protobuf:"varint,2,opt,name=component,proto3,enum=specs.SecretRotationSpec_Component" json:"component,omitempty"`
	// If phase is Failed, this contains the error message.
	Error string `protobuf:"bytes,3,opt,name=error,proto3" json:"error,omitempty"`
	// Contains the current rotation step.
	Step string `protobuf:"bytes,4,opt,name=step,proto3" json:"step,omitempty"`
	// Contains the current rotation step progress.
...
func (x *ClusterSecretsRotationStatusSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ClusterSecretsRotationStatusSpec) GetComponent() SecretRotationSpec_Component {
	if x != nil {
		return x.Component
	}
	return SecretRotationSpec_NONE
...
func (x *ClusterSecretsRotationStatusSpec) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *ClusterSecretsRotationStatusSpec) GetStep() string {
	if x != nil {
		return x.Step
	}
	return ""
...
func (x *ClusterSecretsRotationStatusSpec) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
// ClusterMachineSecretsSpec describes cluster machine secrets.
type ClusterMachineSecretsSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Data holds serialized cluster machine secrets.
	Data []byte `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	// Rotation holds the status of the ongoing secrets rotation.
	Rotation      *ClusterMachineSecretsSpec_Rotation `protobuf:"bytes,2,opt,name=rotation,proto3" json:"rotation,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ClusterMachineSecretsSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ClusterMachineSecretsSpec) GetRotation() *ClusterMachineSecretsSpec_Rotation {
	if x != nil {
		return x.Rotation
	}
	return nil
...
// RotateKubernetesCASpec is used to initiate Kubernetes CA rotation.
type RotateKubernetesCASpec struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RotateKubernetesCASpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type UpgradeRolloutSpec struct {
	state                   protoimpl.MessageState `protogen:"open.v1"`
	MachineSetsUpgradeQuota map[string]int32       `protobuf:"bytes,1,rep,name=machine_sets_upgrade_quota,json=machineSetsUpgradeQuota,proto3" json:"machine_sets_upgrade_quota,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *UpgradeRolloutSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *UpgradeRolloutSpec) GetMachineSetsUpgradeQuota() map[string]int32 {
	if x != nil {
		return x.MachineSetsUpgradeQuota
	}
	return nil
}
...
type NotificationSpec struct {
	...
	Type          NotificationSpec_Type  `protobuf:"varint,3,opt,name=type,proto3,enum=specs.NotificationSpec_Type" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NotificationSpec) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
func (x *NotificationSpec) GetType() NotificationSpec_Type {
	if x != nil {
		return x.Type
	}
	return NotificationSpec_INFO
}

// KubernetesManifestGroup is the collection (or a single) kubernetes manifests to be applied on the cluster.
type KubernetesManifestGroupSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Deprecated: use accessor methods GetUncompressedData/SetUncompressedData to manage this field.
...
func (x *KubernetesManifestGroupSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *KubernetesManifestGroupSpec) GetMode() KubernetesManifestGroupSpec_Mode {
	if x != nil {
		return x.Mode
	}
	return KubernetesManifestGroupSpec_UNKNOWN
}

type ClusterKubernetesManifestsStatusSpec struct {
	state         protoimpl.MessageState                                       `protogen:"open.v1"`
	Groups        map[string]*ClusterKubernetesManifestsStatusSpec_GroupStatus `protobuf:"bytes,1,rep,name=groups,proto3" json:"groups,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	OutOfSync     int32                                                        `protobuf:"varint,2,opt,name=out_of_sync,json=outOfSync,proto3" json:"out_of_sync,omitempty"`
...
func (x *ClusterKubernetesManifestsStatusSpec) GetLastError() string {
	if x != nil {
		return x.LastError
	}
	return ""
...
// HealthcheckSpec describes a Healthcheck.
type KubernetesHealthCheckSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// job is the full Kubernetes Job manifest (YAML) Omni runs to perform the healthcheck. The job runs the
	// check as a single container that terminates: exit code 0 means healthy, a failed job means unhealthy.
	// The job manifest is responsible for its own namespace, service account and RBAC (e.g. provided via
	// KubernetesManifests). Omni overrides the job's name and creates it fresh on every attempt.
	Job string `protobuf:"bytes,1,opt,name=job,proto3" json:"job,omitempty"`
	// interval is how often Omni re-checks (re-creates the job and polls its status) while it is holding an
	// upgrade. If not set, a default interval is used.
...
func (x *KubernetesHealthCheckSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *KubernetesHealthCheckSpec) GetInterval() *durationpb.Duration {
	if x != nil {
		return x.Interval
	}
	return nil
...
// MachineConfigExtractionStatusSpec tracks whether the config a machine arrived with has been extracted into a config patch.
type MachineConfigExtractionStatusSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Initialized is set once the machine's incoming config has been extracted (or determined to be empty / not preservable).
	Initialized bool `protobuf:"varint,1,opt,name=initialized,proto3" json:"initialized,omitempty"`
	// Error is set if the machine's incoming config could not be preserved as an editable config patch (e.g. it contains fields not allowed in a config patch). No patch is created in that case.
	Error         string `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MachineConfigExtractionStatusSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MachineConfigExtractionStatusSpec) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
// Exactly one of Disk and DiskSelector is set.
type MachineInstallDiskConfigSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// DiskSelector selects the install disk by a CEL expression evaluated against each of the machine's disks (Talos disk locator environment).
	DiskSelector string `protobuf:"bytes,1,opt,name=disk_selector,json=diskSelector,proto3" json:"disk_selector,omitempty"`
	// Disk selects the install disk by its dev path.
...
func (x *MachineInstallDiskConfigSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MachineInstallDiskConfigSpec) GetDisk() string {
	if x != nil {
		return x.Disk
	}
	return ""
...
// MachineInstallDiskStatusSpec describes the resolved install disk of a machine.
type MachineInstallDiskStatusSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	// Because of this, the only backend consumer, ClusterMachineConfigController, reads it
	// through installdisk.GetResolved, which detects the staleness. Everything downstream
	// uses the disk recorded on ClusterMachineConfig instead.
	...
	// SelectionHash is the hash of the MachineInstallDiskConfig fields this install disk
	// resolution was computed from. It is empty when there was no selection. Comparing it
	// against the hash of the current selection tells whether the resolution is stale.
	SelectionHash string `protobuf:"bytes,4,opt,name=selection_hash,json=selectionHash,proto3" json:"selection_hash,omitempty"`
	// Disks lists every disk of the machine with its install disk eligibility. The candidates
	// come first in the automatic preference order, then the disks only an explicit selection
	// can target, then the rest.
	Disks         []*MachineInstallDiskStatusSpec_Disk `protobuf:"bytes,2,rep,name=disks,proto3" json:"disks,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MachineInstallDiskStatusSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MachineInstallDiskStatusSpec) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *MachineInstallDiskStatusSpec) GetSelectionHash() string {
	if x != nil {
...
func (x *MachineInstallDiskStatusSpec) GetDisks() []*MachineInstallDiskStatusSpec_Disk {
	if x != nil {
		return x.Disks
	}
	return nil
...
type MachineStatusSpec_HardwareStatus_BlockDevice struct {
	...
	// DevPath is the device path (e.g. `/dev/sda`) as reported by Talos.
	DevPath string `protobuf:"bytes,14,opt,name=dev_path,json=devPath,proto3" json:"dev_path,omitempty"`
	// IoSize is the optimal I/O size of the disk in bytes.
	IoSize uint64 `protobuf:"varint,15,opt,name=io_size,json=ioSize,proto3" json:"io_size,omitempty"`
	// SectorSize is the logical sector size of the disk in bytes.
	SectorSize uint64 `protobuf:"varint,16,opt,name=sector_size,json=sectorSize,proto3" json:"sector_size,omitempty"`
	// Modalias is the modalias of the disk device.
	Modalias string `protobuf:"bytes,17,opt,name=modalias,proto3" json:"modalias,omitempty"`
	// SubSystem is the subsystem path of the disk device.
	SubSystem string `protobuf:"bytes,18,opt,name=sub_system,json=subSystem,proto3" json:"sub_system,omitempty"`
	// Rotational is true for spinning disks.
	Rotational bool `protobuf:"varint,19,opt,name=rotational,proto3" json:"rotational,omitempty"`
	// Cdrom is true for CD-ROM devices.
	Cdrom bool `protobuf:"varint,20,opt,name=cdrom,proto3" json:"cdrom,omitempty"`
	// PrettySize is the human-readable disk size.
	PrettySize string `protobuf:"bytes,21,opt,name=pretty_size,json=prettySize,proto3" json:"pretty_size,omitempty"`
	// SecondaryDisks lists the disks this device is composed of (e.g. RAID members, device-mapper parents).
	SecondaryDisks []string `protobuf:"bytes,22,rep,name=secondary_disks,json=secondaryDisks,proto3" json:"secondary_disks,omitempty"`
	// Symlinks lists the stable symlink paths of the device (e.g. `/dev/disk/by-id/...`).
	Symlinks []string `protobuf:"bytes,23,rep,name=symlinks,proto3" json:"symlinks,omitempty"`
	// FirmwareVersion is the firmware version of the disk.
...
func (x *MachineStatusSpec_HardwareStatus_BlockDevice) GetDevPath() string {
	if x != nil {
		return x.DevPath
	}
	return ""
...
func (x *MachineStatusSpec_HardwareStatus_BlockDevice) GetIoSize() uint64 {
	if x != nil {
		return x.IoSize
	}
	return 0
...
func (x *MachineStatusSpec_HardwareStatus_BlockDevice) GetSectorSize() uint64 {
	if x != nil {
		return x.SectorSize
	}
	return 0
...
func (x *MachineStatusSpec_HardwareStatus_BlockDevice) GetModalias() string {
	if x != nil {
		return x.Modalias
	}
	return ""
...
func (x *MachineStatusSpec_HardwareStatus_BlockDevice) GetSubSystem() string {
	if x != nil {
		return x.SubSystem
	}
	return ""
...
func (x *MachineStatusSpec_HardwareStatus_BlockDevice) GetRotational() bool {
	if x != nil {
		return x.Rotational
	}
	return false
...
func (x *MachineStatusSpec_HardwareStatus_BlockDevice) GetCdrom() bool {
	if x != nil {
		return x.Cdrom
	}
	return false
...
func (x *MachineStatusSpec_HardwareStatus_BlockDevice) GetPrettySize() string {
	if x != nil {
		return x.PrettySize
	}
	return ""
...
func (x *MachineStatusSpec_HardwareStatus_BlockDevice) GetSecondaryDisks() []string {
	if x != nil {
...
func (x *MachineStatusSpec_HardwareStatus_BlockDevice) GetSymlinks() []string {
	if x != nil {
		return x.Symlinks
	}
	return nil
...
func (x *MachineStatusSpec_HardwareStatus_BlockDevice) GetFirmwareVersion() string {
	if x != nil {
...
type MachinePendingUpdatesSpec_Upgrade struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FromSchematic string                 `protobuf:"bytes,1,opt,name=from_schematic,json=fromSchematic,proto3" json:"from_schematic,omitempty"`
	ToSchematic   string                 `protobuf:"bytes,2,opt,name=to_schematic,json=toSchematic,proto3" json:"to_schematic,omitempty"`
...
func (x *MachinePendingUpdatesSpec_Upgrade) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MachinePendingUpdatesSpec_Upgrade) GetFromSchematic() string {
	if x != nil {
		return x.FromSchematic
	}
	return ""
}

func (x *MachinePendingUpdatesSpec_Upgrade) GetToSchematic() string {
	if x != nil {
		return x.ToSchematic
	}
	return ""
}

func (x *MachinePendingUpdatesSpec_Upgrade) GetFromVersion() string {
	if x != nil {
...
func (x *MachinePendingUpdatesSpec_Upgrade) GetToVersion() string {
	if x != nil {
		return x.ToVersion
	}
	return ""
...
type ClusterSecretsSpec_Certs struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Os holds the cluster OS CA.
	Os *ClusterSecretsSpec_Certs_CA `protobuf:"bytes,1,opt,name=os,proto3" json:"os,omitempty"`
	// K8s holds the cluster Kubernetes CA.
	K8S           *ClusterSecretsSpec_Certs_CA `protobuf:"bytes,2,opt,name=k8s,proto3" json:"k8s,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ClusterSecretsSpec_Certs) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ClusterSecretsSpec_Certs) GetK8S() *ClusterSecretsSpec_Certs_CA {
	if x != nil {
		return x.K8S
	}
	return nil
...
type ClusterSecretsSpec_Certs_CA struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ClusterSecretsSpec_Certs_CA) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ClusterSecretsSpec_Certs_CA) GetKey() []byte {
	if x != nil {
		return x.Key
	}
	return nil
...
type InstallationMediaConfigSpec_Cloud struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Platform      string                 `protobuf:"bytes,1,opt,name=platform,proto3" json:"platform,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *InstallationMediaConfigSpec_Cloud) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type InstallationMediaConfigSpec_SBC struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Overlay        string                 `protobuf:"bytes,1,opt,name=overlay,proto3" json:"overlay,omitempty"`
	OverlayOptions string                 `protobuf:"bytes,2,opt,name=overlay_options,json=overlayOptions,proto3" json:"overlay_options,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *InstallationMediaConfigSpec_SBC) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *InstallationMediaConfigSpec_SBC) GetOverlayOptions() string {
	if x != nil {
		return x.OverlayOptions
	}
	return ""
}

type ClusterMachineSecretsSpec_Rotation struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Status holds the status of the secrets rotation.
	Status SecretRotationSpec_Status `protobuf:"varint,1,opt,name=status,proto3,enum=specs.SecretRotationSpec_Status" json:"status,omitempty"`
	// Phase holds the current phase of the ongoing secrets rotation.
	Phase SecretRotationSpec_Phase `protobuf:"varint,2,opt,name=phase,proto3,enum=specs.SecretRotationSpec_Phase" json:"phase,omitempty"`
	// Component holds the component currently being rotated.
	Component SecretRotationSpec_Component `protobuf:"varint,3,opt,name=component,proto3,enum=specs.SecretRotationSpec_Component" json:"component,omitempty"`
	// Extra_certs holds extra cluster CAs to be used during CA rotation.
	ExtraCerts *ClusterSecretsSpec_Certs `protobuf:"bytes,4,opt,name=extra_certs,json=extraCerts,proto3" json:"extra_certs,omitempty"`
	// Secret_rotation_version holds the version of the SecretsRotation used to build Rotation.
	SecretRotationVersion string `protobuf:"bytes,5,opt,name=secret_rotation_version,json=secretRotationVersion,proto3" json:"secret_rotation_version,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *ClusterMachineSecretsSpec_Rotation) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ClusterMachineSecretsSpec_Rotation) GetPhase() SecretRotationSpec_Phase {
	if x != nil {
		return x.Phase
	}
	return SecretRotationSpec_OK
...
func (x *ClusterMachineSecretsSpec_Rotation) GetComponent() SecretRotationSpec_Component {
	if x != nil {
		return x.Component
	}
	return SecretRotationSpec_NONE
...
func (x *ClusterMachineSecretsSpec_Rotation) GetExtraCerts() *ClusterSecretsSpec_Certs {
	if x != nil {
		return x.ExtraCerts
	}
	return nil
...
func (x *ClusterKubernetesManifestsStatusSpec_ManifestStatus) GetGroup() string {
	if x != nil {
		return x.Group
	}
	return ""
...
type ClusterKubernetesManifestsStatusSpec_GroupStatus struct {
	state         protoimpl.MessageState                                          `protogen:"open.v1"`
	Phase         ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase          `protobuf:"varint,1,opt,name=phase,proto3,enum=specs.ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase" json:"phase,omitempty"`
	Mode          KubernetesManifestGroupSpec_Mode                                `protobuf:"varint,2,opt,name=mode,proto3,enum=specs.KubernetesManifestGroupSpec_Mode" json:"mode,omitempty"`
	Manifests     map[string]*ClusterKubernetesManifestsStatusSpec_ManifestStatus `protobuf:"bytes,3,rep,name=manifests,proto3" json:"manifests,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ClusterKubernetesManifestsStatusSpec_GroupStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ClusterKubernetesManifestsStatusSpec_GroupStatus) GetPhase() ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase {
	...
	return ClusterKubernetesManifestsStatusSpec_GroupStatus_UNKNOWN
}

func (x *ClusterKubernetesManifestsStatusSpec_GroupStatus) GetMode() KubernetesManifestGroupSpec_Mode {
	if x != nil {
		return x.Mode
	}
	return KubernetesManifestGroupSpec_UNKNOWN
...
func (x *ClusterKubernetesManifestsStatusSpec_GroupStatus) GetManifests() map[string]*ClusterKubernetesManifestsStatusSpec_ManifestStatus {
	if x != nil {
		return x.Manifests
	}
	return nil
...
type MachineInstallDiskStatusSpec_Disk struct {
	...
	// Selectable reports whether the disk can be picked as the install disk. Candidates are
	// always selectable. A disk built on top of other disks is selectable with a skip
	// reason: only an explicit selection may target it.
	Selectable bool `protobuf:"varint,2,opt,name=selectable,proto3" json:"selectable,omitempty"`
	// SkipReason explains why the automatic selection skips this disk. Empty means the disk
	// is a candidate.
	SkipReason string `protobuf:"bytes,3,opt,name=skip_reason,json=skipReason,proto3" json:"skip_reason,omitempty"`
	// Members lists the short kernel names of the disks this disk is built on top of.
...
func (x *MachineInstallDiskStatusSpec_Disk) Reset() {
	*x = MachineInstallDiskStatusSpec_Disk{}
	mi := &file_omni_specs_omni_proto_msgTypes[162]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MachineInstallDiskStatusSpec_Disk) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*MachineInstallDiskStatusSpec_Disk) Descriptor() ([]byte, []int) {
	return file_omni_specs_omni_proto_rawDescGZIP(), []int{110, 0}
}
...
func (x *MachineInstallDiskStatusSpec_Disk) GetSelectable() bool {
	if x != nil {
		return x.Selectable
	}
	return false
...
func (x *MachineInstallDiskStatusSpec_Disk) GetSkipReason() string {
	if x != nil {
		return x.SkipReason
	}
	return ""
...
func (x *MachineInstallDiskStatusSpec_Disk) GetMembers() []string {
	if x != nil {
		return x.Members
	}
	return nil
...
const file_omni_specs_omni_proto_rawDesc = "" +
	...
	"\x0fuse_grpc_tunnel\x18\x05 \x01(\bR\ruseGrpcTunnelJ\x04\b\x03\x10\x04J\x04\b\x04\x10\x05\"\xec\x01\n" +
	"\rSecurityState\x12\x1f\n" +
	"\vsecure_boot\x18\x01 \x01(\bR\n" +
	"secureBoot\x12&\n" +
	"\x0fbooted_with_uki\x18\x02 \x01(\bR\rbootedWithUki\x12=\n" +
	"\n" +
	"fips_state\x18\x03 \x01(\x0e2\x1e.specs.SecurityState.FIPSStateR\tfipsState\"S\n" +
	"\tFIPSState\x12\x17\n" +
	"\x13FIPS_STATE_DISABLED\x10\x00\x12\x16\n" +
	"\x12FIPS_STATE_ENABLED\x10\x01\x12\x15\n" +
	"\x11FIPS_STATE_STRICT\x10\x02\"3\n" +
	"\aOverlay\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05image\x18\x02 \x01(\tR\x05image\"3\n" +
	"\tMetaValue\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"\x89\x1d\n" +
	...
	"\x0ekernel_cmdline\x18\x16 \x01(\tR\rkernelCmdline\x12,\n" +
	"\x12talos_version_name\x18\x17 \x01(\tR\x10talosVersionName\x1a\xba\t\n" +
	...
	"\vdescription\x18\x02 \x01(\tR\vdescription\x1a\x8b\x05\n" +
	...
	"\ttransport\x18\r \x01(\tR\ttransport\x12\x19\n" +
	"\bdev_path\x18\x0e \x01(\tR\adevPath\x12\x17\n" +
	"\aio_size\x18\x0f \x01(\x04R\x06ioSize\x12\x1f\n" +
	"\vsector_size\x18\x10 \x01(\x04R\n" +
	"sectorSize\x12\x1a\n" +
	"\bmodalias\x18\x11 \x01(\tR\bmodalias\x12\x1d\n" +
	"\n" +
	"sub_system\x18\x12 \x01(\tR\tsubSystem\x12\x1e\n" +
	"\n" +
	"rotational\x18\x13 \x01(\bR\n" +
	"rotational\x12\x14\n" +
	"\x05cdrom\x18\x14 \x01(\bR\x05cdrom\x12\x1f\n" +
	"\vpretty_size\x18\x15 \x01(\tR\n" +
	"prettySize\x12'\n" +
	"\x0fsecondary_disks\x18\x16 \x03(\tR\x0esecondaryDisks\x12\x1a\n" +
	"\bsymlinks\x18\x17 \x03(\tR\bsymlinks\x12)\n" +
	"\x10firmware_version\x18\x18 \x01(\tR\x0ffirmwareVersion\x1a\xad\x03\n" +
	...
	"\x14grub_use_uki_cmdline\x18\x06 \x01(\bR\x11grubUseUkiCmdline\x12!\n" +
	"\finstall_disk\x18\a \x01(\tR\vinstallDiskJ\x04\b\x02\x10\x03\"_\n" +
	...
	"\vextra_certs\x18\x03 \x01(\v2\x1f.specs.ClusterSecretsSpec.CertsR\n" +
	"extraCerts\x1a\x9b\x01\n" +
	"\x05Certs\x122\n" +
	"\x02os\x18\x01 \x01(\v2\".specs.ClusterSecretsSpec.Certs.CAR\x02os\x124\n" +
	"\x03k8s\x18\x02 \x01(\v2\".specs.ClusterSecretsSpec.Certs.CAR\x03k8s\x1a(\n" +
	"\x02CA\x12\x10\n" +
	...
	"\x04data\x18\x01 \x01(\tR\x04data\x12'\n" +
	"\x0fcompressed_data\x18\x02 \x01(\fR\x0ecompressedData\"\xd2\v\n" +
	...
	"\x12machine_allocation\x18\a \x01(\v2'.specs.MachineSetSpec.MachineAllocationR\x11machineAllocation\x12O\n" +
	"\x10upgrade_strategy\x18\b \x01(\x0e2$.specs.MachineSetSpec.UpdateStrategyR\x0fupgradeStrategy\x12b\n" +
	"\x17upgrade_strategy_config\x18\t \x01(\v2*.specs.MachineSetSpec.UpdateStrategyConfigR\x15upgradeStrategyConfig\x1a\xbc\x01\n" +
	...
	"\x19UpdatingMachineSchematics\x10\x05\"\xcf\x02\n" +
	...
	"\x0elocked_updates\x18\a \x01(\rR\rlockedUpdatesJ\x04\b\b\x10\tJ\x04\b\t\x10\n" +
	"J\x04\b\n" +
	"\x10\v\"\xb7\x02\n" +
	"\x1aMachineSetConfigStatusSpec\x124\n" +
	"\x16config_updates_allowed\x18\x01 \x01(\bR\x14configUpdatesAllowed\x122\n" +
	"\x15should_reset_graceful\x18\x02 \x01(\bR\x13shouldResetGraceful\x12M\n" +
	...
	"\x05phase\x18\x01 \x01(\tR\x05phase\"\xc6\x03\n" +
	...
	"\x0fmachine_upgrade\x18\x05 \x01(\v2\x1f.specs.MachineUpgradeStatusSpecH\x00R\x0emachineUpgrade\x12T\n" +
	"\x10secrets_rotation\x18\a \x01(\v2'.specs.ClusterSecretsRotationStatusSpecH\x00R\x0fsecretsRotation\x12\x1f\n" +
	...
	"\bapi_host\x18\x02 \x01(\tR\aapiHost\"I\n" +
	"\x0eStripeSettings\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\x1d\n" +
	"\n" +
	"min_commit\x18\x02 \x01(\rR\tminCommit\"-\n" +
	"\aAccount\x12\x0e\n" +
	...
	"kernelArgs\x12>\n" +
	"\x05cloud\x18\x05 \x01(\v2(.specs.InstallationMediaConfigSpec.CloudR\x05cloud\x128\n" +
	"\x03sbc\x18\x06 \x01(\v2&.specs.InstallationMediaConfigSpec.SBCR\x03sbc\x12\x1d\n" +
	"\n" +
	"join_token\x18\a \x01(\tR\tjoinToken\x12\x1f\n" +
	"\vsecure_boot\x18\b \x01(\bR\n" +
	"secureBoot\x126\n" +
	"\vgrpc_tunnel\x18\t \x01(\x0e2\x15.specs.GrpcTunnelModeR\n" +
	"grpcTunnel\x12\\\n" +
	"\x0emachine_labels\x18\n" +
	...
	"\x03SBC\x12\x18\n" +
	"\aoverlay\x18\x01 \x01(\tR\aoverlay\x12'\n" +
	"\x0foverlay_options\x18\x02 \x01(\tR\x0eoverlayOptions\x1a@\n" +
	"\x12MachineLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x13\n" +
	"\x11RotateTalosCASpec\"\xf6\x04\n" +
	"\x12SecretRotationSpec\x128\n" +
	"\x06status\x18\x01 \x01(\x0e2 .specs.SecretRotationSpec.StatusR\x06status\x125\n" +
	"\x05phase\x18\x02 \x01(\x0e2\x1f.specs.SecretRotationSpec.PhaseR\x05phase\x12A\n" +
	"\tcomponent\x18\x03 \x01(\x0e2#.specs.SecretRotationSpec.ComponentR\tcomponent\x125\n" +
	"\x05certs\x18\x04 \x01(\v2\x1f.specs.ClusterSecretsSpec.CertsR\x05certs\x12@\n" +
	"\vextra_certs\x18\x05 \x01(\v2\x1f.specs.ClusterSecretsSpec.CertsR\n" +
	"extraCerts\x12J\n" +
	"\x0fbackup_certs_os\x18\x06 \x03(\v2\".specs.ClusterSecretsSpec.Certs.CAR\rbackupCertsOs\x12L\n" +
	"\x10backup_certs_k8s\x18\a \x03(\v2\".specs.ClusterSecretsSpec.Certs.CAR\x0ebackupCertsK8s\"#\n" +
	"\x06Status\x12\b\n" +
	"\x04IDLE\x10\x00\x12\x0f\n" +
	"\vIN_PROGRESS\x10\x01\"<\n" +
	"\x05Phase\x12\x06\n" +
	"\x02OK\x10\x00\x12\x0e\n" +
	"\n" +
	"PRE_ROTATE\x10\x01\x12\n" +
	"\n" +
	"\x06ROTATE\x10\x02\x12\x0f\n" +
	"\vPOST_ROTATE\x10\x03\"6\n" +
	"\tComponent\x12\b\n" +
	"\x04NONE\x10\x00\x12\f\n" +
	"\bTALOS_CA\x10\x01\x12\x11\n" +
	"\rKUBERNETES_CA\x10\x02\"\xde\x01\n" +
	" ClusterSecretsRotationStatusSpec\x125\n" +
	"\x05phase\x18\x01 \x01(\x0e2\x1f.specs.SecretRotationSpec.PhaseR\x05phase\x12A\n" +
	"\tcomponent\x18\x02 \x01(\x0e2#.specs.SecretRotationSpec.ComponentR\tcomponent\x12\x14\n" +
	"\x05error\x18\x03 \x01(\tR\x05error\x12\x12\n" +
	"\x04step\x18\x04 \x01(\tR\x04step\x12\x16\n" +
	"\x06status\x18\x05 \x01(\tR\x06status\"\xb1\x03\n" +
	"\x19ClusterMachineSecretsSpec\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\x12E\n" +
	"\brotation\x18\x02 \x01(\v2).specs.ClusterMachineSecretsSpec.RotationR\brotation\x1a\xb8\x02\n" +
	"\bRotation\x128\n" +
	"\x06status\x18\x01 \x01(\x0e2 .specs.SecretRotationSpec.StatusR\x06status\x125\n" +
	"\x05phase\x18\x02 \x01(\x0e2\x1f.specs.SecretRotationSpec.PhaseR\x05phase\x12A\n" +
	...
	"extraCerts\x126\n" +
	"\x17secret_rotation_version\x18\x05 \x01(\tR\x15secretRotationVersion\"\x18\n" +
	"\x16RotateKubernetesCASpec\"\xd5\x01\n" +
	"\x12UpgradeRolloutSpec\x12s\n" +
	"\x1amachine_sets_upgrade_quota\x18\x01 \x03(\v26.specs.UpgradeRolloutSpec.MachineSetsUpgradeQuotaEntryR\x17machineSetsUpgradeQuota\x1aJ\n" +
	...
	"\n" +
	"last_error\x18\x04 \x01(\tR\tlastError\x1a\x82\x02\n" +
	"\x0eManifestStatus\x12V\n" +
	"\x05phase\x18\x01 \x01(\x0e2@.specs.ClusterKubernetesManifestsStatusSpec.ManifestStatus.PhaseR\x05phase\x12\x12\n" +
	...
	"\bDELETING\x10\x03\x1a\xce\x03\n" +
	"\vGroupStatus\x12S\n" +
	"\x05phase\x18\x01 \x01(\x0e2=.specs.ClusterKubernetesManifestsStatusSpec.GroupStatus.PhaseR\x05phase\x12;\n" +
	"\x04mode\x18\x02 \x01(\x0e2'.specs.KubernetesManifestGroupSpec.ModeR\x04mode\x12d\n" +
	"\tmanifests\x18\x03 \x03(\v2F.specs.ClusterKubernetesManifestsStatusSpec.GroupStatus.ManifestsEntryR\tmanifests\x1ax\n" +
	"\x0eManifestsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12P\n" +
	"\x05value\x18\x02 \x01(\v2:.specs.ClusterKubernetesManifestsStatusSpec.ManifestStatusR\x05value:\x028\x01\"M\n" +
	"\x05Phase\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\v\n" +
	"\aPENDING\x10\x01\x12\x0f\n" +
	"\vPROGRESSING\x10\x02\x12\v\n" +
	"\aAPPLIED\x10\x03\x12\f\n" +
	"\bDELETING\x10\x04\x1ar\n" +
	"\vGroupsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12M\n" +
	"\x05value\x18\x02 \x01(\v27.specs.ClusterKubernetesManifestsStatusSpec.GroupStatusR\x05value:\x028\x01\"d\n" +
	"\x19KubernetesHealthCheckSpec\x12\x10\n" +
	"\x03job\x18\x01 \x01(\tR\x03job\x125\n" +
	...
	"\x1cMachineInstallDiskStatusSpec\x12\x12\n" +
	"\x04disk\x18\x01 \x01(\tR\x04disk\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\x12%\n" +
	"\x0eselection_hash\x18\x04 \x01(\tR\rselectionHash\x12>\n" +
	"\x05disks\x18\x02 \x03(\v2(.specs.MachineInstallDiskStatusSpec.DiskR\x05disks\x1a|\n" +
	"\x04Disk\x12\x19\n" +
	"\bdev_path\x18\x01 \x01(\tR\adevPath\x12\x1e\n" +
	"\n" +
	"selectable\x18\x02 \x01(\bR\n" +
	"selectable\x12\x1f\n" +
	"\vskip_reason\x18\x03 \x01(\tR\n" +
	"skipReason\x12\x18\n" +
	"\amembers\x18\x04 \x03(\tR\amembers*F\n" +
...
var file_omni_specs_omni_proto_enumTypes = make([]protoimpl.EnumInfo, 30)
var file_omni_specs_omni_proto_msgTypes = make([]protoimpl.MessageInfo, 163)
var file_omni_specs_omni_proto_goTypes = []any{
	...
	(SecurityState_FIPSState)(0),                                   // 4: specs.SecurityState.FIPSState
	(MachineStatusSpec_Role)(0),                                    // 5: specs.MachineStatusSpec.Role
	(MachineStatusSpec_PowerState)(0),                              // 6: specs.MachineStatusSpec.PowerState
	(EtcdBackupStatusSpec_Status)(0),                               // 7: specs.EtcdBackupStatusSpec.Status
	(ClusterMachineStatusSpec_Stage)(0),                            // 8: specs.ClusterMachineStatusSpec.Stage
	(ClusterStatusSpec_Phase)(0),                                   // 9: specs.ClusterStatusSpec.Phase
	(MachineSetSpec_UpdateStrategy)(0),                             // 10: specs.MachineSetSpec.UpdateStrategy
	(MachineSetSpec_MachineClass_Type)(0),                          // 11: specs.MachineSetSpec.MachineClass.Type
	(MachineSetSpec_MachineAllocation_Type)(0),                     // 12: specs.MachineSetSpec.MachineAllocation.Type
	...
	(MachineUpgradeStatusSpec_Phase)(0),                            // 18: specs.MachineUpgradeStatusSpec.Phase
	...
	(SecretRotationSpec_Status)(0),                                 // 23: specs.SecretRotationSpec.Status
	(SecretRotationSpec_Phase)(0),                                  // 24: specs.SecretRotationSpec.Phase
	(SecretRotationSpec_Component)(0),                              // 25: specs.SecretRotationSpec.Component
	(NotificationSpec_Type)(0),                                     // 26: specs.NotificationSpec.Type
	(KubernetesManifestGroupSpec_Mode)(0),                          // 27: specs.KubernetesManifestGroupSpec.Mode
	(ClusterKubernetesManifestsStatusSpec_ManifestStatus_Phase)(0), // 28: specs.ClusterKubernetesManifestsStatusSpec.ManifestStatus.Phase
	(ClusterKubernetesManifestsStatusSpec_GroupStatus_Phase)(0),    // 29: specs.ClusterKubernetesManifestsStatusSpec.GroupStatus.Phase
	(*MachineSpec)(nil),                                            // 30: specs.MachineSpec
	(*SecurityState)(nil),                                          // 31: specs.SecurityState
	(*Overlay)(nil),                                                // 32: specs.Overlay
	(*MetaValue)(nil),                                              // 33: specs.MetaValue
	(*MachineStatusSpec)(nil),                                      // 34: specs.MachineStatusSpec
	(*TalosConfigSpec)(nil),                                        // 35: specs.TalosConfigSpec
	(*ClusterSpec)(nil),                                            // 36: specs.ClusterSpec
	(*ClusterTaintSpec)(nil),                                       // 37: specs.ClusterTaintSpec
	(*EtcdBackupConf)(nil),                                         // 38: specs.EtcdBackupConf
	(*EtcdBackupEncryptionSpec)(nil),                               // 39: specs.EtcdBackupEncryptionSpec
	(*EtcdBackupHeader)(nil),                                       // 40: specs.EtcdBackupHeader
	(*EtcdBackupSpec)(nil),                                         // 41: specs.EtcdBackupSpec
	(*BackupDataSpec)(nil),                                         // 42: specs.BackupDataSpec
	(*EtcdBackupS3ConfSpec)(nil),                                   // 43: specs.EtcdBackupS3ConfSpec
	(*EtcdBackupStatusSpec)(nil),                                   // 44: specs.EtcdBackupStatusSpec
	(*EtcdManualBackupSpec)(nil),                                   // 45: specs.EtcdManualBackupSpec
	(*EtcdBackupStoreStatusSpec)(nil),                              // 46: specs.EtcdBackupStoreStatusSpec
	(*EtcdBackupOverallStatusSpec)(nil),                            // 47: specs.EtcdBackupOverallStatusSpec
	(*ClusterMachineSpec)(nil),                                     // 48: specs.ClusterMachineSpec
	(*ClusterMachineConfigPatchesSpec)(nil),                        // 49: specs.ClusterMachineConfigPatchesSpec
	(*ClusterMachineTalosVersionSpec)(nil),                         // 50: specs.ClusterMachineTalosVersionSpec
	(*ClusterMachineConfigSpec)(nil),                               // 51: specs.ClusterMachineConfigSpec
	(*RedactedClusterMachineConfigSpec)(nil),                       // 52: specs.RedactedClusterMachineConfigSpec
	(*ClusterMachineIdentitySpec)(nil),                             // 53: specs.ClusterMachineIdentitySpec
	(*ClusterMachineStatusSpec)(nil),                               // 54: specs.ClusterMachineStatusSpec
	(*Machines)(nil),                                               // 55: specs.Machines
	(*ClusterStatusSpec)(nil),                                      // 56: specs.ClusterStatusSpec
	(*ClusterUUID)(nil),                                            // 57: specs.ClusterUUID
	(*ClusterConfigVersionSpec)(nil),                               // 58: specs.ClusterConfigVersionSpec
	(*ClusterMachineConfigStatusSpec)(nil),                         // 59: specs.ClusterMachineConfigStatusSpec
	(*MachinePendingUpdatesSpec)(nil),                              // 60: specs.MachinePendingUpdatesSpec
	(*ClusterBootstrapStatusSpec)(nil),                             // 61: specs.ClusterBootstrapStatusSpec
	(*ClusterSecretsSpec)(nil),                                     // 62: specs.ClusterSecretsSpec
	(*ImportedClusterSecretsSpec)(nil),                             // 63: specs.ImportedClusterSecretsSpec
	(*LoadBalancerConfigSpec)(nil),                                 // 64: specs.LoadBalancerConfigSpec
	(*LoadBalancerStatusSpec)(nil),                                 // 65: specs.LoadBalancerStatusSpec
	(*KubernetesVersionSpec)(nil),                                  // 66: specs.KubernetesVersionSpec
	(*TalosVersionSpec)(nil),                                       // 67: specs.TalosVersionSpec
	(*InstallationMediaSpec)(nil),                                  // 68: specs.InstallationMediaSpec
	(*ConfigPatchSpec)(nil),                                        // 69: specs.ConfigPatchSpec
	(*MachineSetSpec)(nil),                                         // 70: specs.MachineSetSpec
	(*TalosUpgradeStatusSpec)(nil),                                 // 71: specs.TalosUpgradeStatusSpec
	(*MachineSetStatusSpec)(nil),                                   // 72: specs.MachineSetStatusSpec
	(*MachineSetConfigStatusSpec)(nil),                             // 73: specs.MachineSetConfigStatusSpec
	(*MachineSetNodeSpec)(nil),                                     // 74: specs.MachineSetNodeSpec
	(*MachineLabelsSpec)(nil),                                      // 75: specs.MachineLabelsSpec
	(*MachineStatusSnapshotSpec)(nil),                              // 76: specs.MachineStatusSnapshotSpec
	(*ControlPlaneStatusSpec)(nil),                                 // 77: specs.ControlPlaneStatusSpec
	(*ClusterEndpointSpec)(nil),                                    // 78: specs.ClusterEndpointSpec
	(*KubernetesStatusSpec)(nil),                                   // 79: specs.KubernetesStatusSpec
	(*KubernetesUpgradeStatusSpec)(nil),                            // 80: specs.KubernetesUpgradeStatusSpec
	(*KubernetesUpgradeManifestStatusSpec)(nil),                    // 81: specs.KubernetesUpgradeManifestStatusSpec
	(*DestroyStatusSpec)(nil),                                      // 82: specs.DestroyStatusSpec
	(*OngoingTaskSpec)(nil),                                        // 83: specs.OngoingTaskSpec
	(*ClusterMachineEncryptionKeySpec)(nil),                        // 84: specs.ClusterMachineEncryptionKeySpec
	(*ExposedServiceSpec)(nil),                                     // 85: specs.ExposedServiceSpec
	(*ClusterWorkloadProxyStatusSpec)(nil),                         // 86: specs.ClusterWorkloadProxyStatusSpec
	(*FeaturesConfigSpec)(nil),                                     // 87: specs.FeaturesConfigSpec
	(*UserPilotSettings)(nil),                                      // 88: specs.UserPilotSettings
	(*PosthogSettings)(nil),                                        // 89: specs.PosthogSettings
	(*StripeSettings)(nil),                                         // 90: specs.StripeSettings
	(*Account)(nil),                                                // 91: specs.Account
	(*EtcdBackupSettings)(nil),                                     // 92: specs.EtcdBackupSettings
	(*MachineClassSpec)(nil),                                       // 93: specs.MachineClassSpec
	(*MachineConfigGenOptionsSpec)(nil),                            // 94: specs.MachineConfigGenOptionsSpec
	(*EtcdAuditResultSpec)(nil),                                    // 95: specs.EtcdAuditResultSpec
	(*KubeconfigSpec)(nil),                                         // 96: specs.KubeconfigSpec
	(*KubernetesUsageSpec)(nil),                                    // 97: specs.KubernetesUsageSpec
	(*ImagePullRequestSpec)(nil),                                   // 98: specs.ImagePullRequestSpec
	(*ImagePullStatusSpec)(nil),                                    // 99: specs.ImagePullStatusSpec
	(*SchematicSpec)(nil),                                          // 100: specs.SchematicSpec
	(*TalosExtensionsSpec)(nil),                                    // 101: specs.TalosExtensionsSpec
	(*SchematicConfigurationSpec)(nil),                             // 102: specs.SchematicConfigurationSpec
	(*ExtensionsConfigurationSpec)(nil),                            // 103: specs.ExtensionsConfigurationSpec
	(*KernelArgsSpec)(nil),                                         // 104: specs.KernelArgsSpec
	(*KernelArgsStatusSpec)(nil),                                   // 105: specs.KernelArgsStatusSpec
	(*MachineUpgradeStatusSpec)(nil),                               // 106: specs.MachineUpgradeStatusSpec
	(*MachineExtensionsSpec)(nil),                                  // 107: specs.MachineExtensionsSpec
	(*MachineExtensionsStatusSpec)(nil),                            // 108: specs.MachineExtensionsStatusSpec
	(*MachineStatusMetricsSpec)(nil),                               // 109: specs.MachineStatusMetricsSpec
	(*ClusterMetricsSpec)(nil),                                     // 110: specs.ClusterMetricsSpec
	(*ClusterStatusMetricsSpec)(nil),                               // 111: specs.ClusterStatusMetricsSpec
	(*ClusterKubernetesNodesSpec)(nil),                             // 112: specs.ClusterKubernetesNodesSpec
	(*KubernetesNodeAuditResultSpec)(nil),                          // 113: specs.KubernetesNodeAuditResultSpec
	(*MachineRequestSetSpec)(nil),                                  // 114: specs.MachineRequestSetSpec
	(*MachineRequestSetStatusSpec)(nil),                            // 115: specs.MachineRequestSetStatusSpec
	(*ClusterDiagnosticsSpec)(nil),                                 // 116: specs.ClusterDiagnosticsSpec
	(*MachineRequestSetPressureSpec)(nil),                          // 117: specs.MachineRequestSetPressureSpec
	(*ClusterMachineRequestStatusSpec)(nil),                        // 118: specs.ClusterMachineRequestStatusSpec
	(*InfraMachineConfigSpec)(nil),                                 // 119: specs.InfraMachineConfigSpec
	(*InfraMachineBMCConfigSpec)(nil),                              // 120: specs.InfraMachineBMCConfigSpec
	(*MaintenanceConfigStatusSpec)(nil),                            // 121: specs.MaintenanceConfigStatusSpec
	(*NodeForceDestroyRequestSpec)(nil),                            // 122: specs.NodeForceDestroyRequestSpec
	(*DiscoveryAffiliateDeleteTaskSpec)(nil),                       // 123: specs.DiscoveryAffiliateDeleteTaskSpec
	(*InfraProviderCombinedStatusSpec)(nil),                        // 124: specs.InfraProviderCombinedStatusSpec
	(*MachineConfigDiffSpec)(nil),                                  // 125: specs.MachineConfigDiffSpec
	(*InstallationMediaConfigSpec)(nil),                            // 126: specs.InstallationMediaConfigSpec
	(*RotateTalosCASpec)(nil),                                      // 127: specs.RotateTalosCASpec
	(*SecretRotationSpec)(nil),                                     // 128: specs.SecretRotationSpec
	(*ClusterSecretsRotationStatusSpec)(nil),                       // 129: specs.ClusterSecretsRotationStatusSpec
	(*ClusterMachineSecretsSpec)(nil),                              // 130: specs.ClusterMachineSecretsSpec
	(*RotateKubernetesCASpec)(nil),                                 // 131: specs.RotateKubernetesCASpec
	(*UpgradeRolloutSpec)(nil),                                     // 132: specs.UpgradeRolloutSpec
	(*NotificationSpec)(nil),                                       // 133: specs.NotificationSpec
	(*KubernetesManifestGroupSpec)(nil),                            // 134: specs.KubernetesManifestGroupSpec
	(*ClusterKubernetesManifestsStatusSpec)(nil),                   // 135: specs.ClusterKubernetesManifestsStatusSpec
	(*KubernetesHealthCheckSpec)(nil),                              // 136: specs.KubernetesHealthCheckSpec
	(*MachineConfigExtractionStatusSpec)(nil),                      // 137: specs.MachineConfigExtractionStatusSpec
	(*ImageFactoryAuthSpec)(nil),                                   // 138: specs.ImageFactoryAuthSpec
	(*MachineInstallDiskConfigSpec)(nil),                           // 139: specs.MachineInstallDiskConfigSpec
	(*MachineInstallDiskStatusSpec)(nil),                           // 140: specs.MachineInstallDiskStatusSpec
	(*MachineStatusSpec_HardwareStatus)(nil),                       // 141: specs.MachineStatusSpec.HardwareStatus
	(*MachineStatusSpec_NetworkStatus)(nil),                        // 142: specs.MachineStatusSpec.NetworkStatus
	(*MachineStatusSpec_PlatformMetadata)(nil),                     // 143: specs.MachineStatusSpec.PlatformMetadata
	(*MachineStatusSpec_Schematic)(nil),                            // 144: specs.MachineStatusSpec.Schematic
	(*MachineStatusSpec_Diagnostic)(nil),                           // 145: specs.MachineStatusSpec.Diagnostic
	nil,                                                            // 146: specs.MachineStatusSpec.ImageLabelsEntry
	(*MachineStatusSpec_HardwareStatus_Processor)(nil),             // 147: specs.MachineStatusSpec.HardwareStatus.Processor
	(*MachineStatusSpec_HardwareStatus_MemoryModule)(nil),          // 148: specs.MachineStatusSpec.HardwareStatus.MemoryModule
	(*MachineStatusSpec_HardwareStatus_BlockDevice)(nil),           // 149: specs.MachineStatusSpec.HardwareStatus.BlockDevice
	(*MachineStatusSpec_NetworkStatus_NetworkLinkStatus)(nil),      // 150: specs.MachineStatusSpec.NetworkStatus.NetworkLinkStatus
	nil, // 151: specs.MachineStatusSpec.PlatformMetadata.TagsEntry
	(*MachineStatusSpec_Schematic_InitialState)(nil),   // 152: specs.MachineStatusSpec.Schematic.InitialState
	(*ClusterSpec_Features)(nil),                       // 153: specs.ClusterSpec.Features
	(*ClusterMachineStatusSpec_ProvisionStatus)(nil),   // 154: specs.ClusterMachineStatusSpec.ProvisionStatus
	(*MachinePendingUpdatesSpec_Upgrade)(nil),          // 155: specs.MachinePendingUpdatesSpec.Upgrade
	(*ClusterSecretsSpec_Certs)(nil),                   // 156: specs.ClusterSecretsSpec.Certs
	(*ClusterSecretsSpec_Certs_CA)(nil),                // 157: specs.ClusterSecretsSpec.Certs.CA
	(*MachineSetSpec_MachineClass)(nil),                // 158: specs.MachineSetSpec.MachineClass
	(*MachineSetSpec_MachineAllocation)(nil),           // 159: specs.MachineSetSpec.MachineAllocation
	(*MachineSetSpec_BootstrapSpec)(nil),               // 160: specs.MachineSetSpec.BootstrapSpec
	(*MachineSetSpec_RollingUpdateStrategyConfig)(nil), // 161: specs.MachineSetSpec.RollingUpdateStrategyConfig
	(*MachineSetSpec_UpdateStrategyConfig)(nil),        // 162: specs.MachineSetSpec.UpdateStrategyConfig
	(*ControlPlaneStatusSpec_Condition)(nil),           // 163: specs.ControlPlaneStatusSpec.Condition
	(*KubernetesStatusSpec_NodeStatus)(nil),            // 164: specs.KubernetesStatusSpec.NodeStatus
	(*KubernetesStatusSpec_StaticPodStatus)(nil),       // 165: specs.KubernetesStatusSpec.StaticPodStatus
	(*KubernetesStatusSpec_NodeStaticPods)(nil),        // 166: specs.KubernetesStatusSpec.NodeStaticPods
	(*MachineClassSpec_Provision)(nil),                 // 167: specs.MachineClassSpec.Provision
	(*MachineConfigGenOptionsSpec_InstallImage)(nil),   // 168: specs.MachineConfigGenOptionsSpec.InstallImage
	(*KubernetesUsageSpec_Quantity)(nil),               // 169: specs.KubernetesUsageSpec.Quantity
	(*KubernetesUsageSpec_Pod)(nil),                    // 170: specs.KubernetesUsageSpec.Pod
	(*ImagePullRequestSpec_NodeImageList)(nil),         // 171: specs.ImagePullRequestSpec.NodeImageList
	(*TalosExtensionsSpec_Info)(nil),                   // 172: specs.TalosExtensionsSpec.Info
	(*MachineExtensionsStatusSpec_Item)(nil),           // 173: specs.MachineExtensionsStatusSpec.Item
	nil,                                                // 174: specs.MachineStatusMetricsSpec.PlatformsEntry
	nil,                                                // 175: specs.MachineStatusMetricsSpec.SecureBootStatusEntry
	nil,                                                // 176: specs.MachineStatusMetricsSpec.UkiStatusEntry
	nil,                                                // 177: specs.ClusterMetricsSpec.FeaturesEntry
	nil,                                                // 178: specs.ClusterStatusMetricsSpec.PhasesEntry
	(*ClusterDiagnosticsSpec_Node)(nil),                // 179: specs.ClusterDiagnosticsSpec.Node
	(*InfraMachineBMCConfigSpec_IPMI)(nil),             // 180: specs.InfraMachineBMCConfigSpec.IPMI
	(*InfraMachineBMCConfigSpec_API)(nil),              // 181: specs.InfraMachineBMCConfigSpec.API
	(*InfraProviderCombinedStatusSpec_Health)(nil),     // 182: specs.InfraProviderCombinedStatusSpec.Health
	(*InstallationMediaConfigSpec_Cloud)(nil),          // 183: specs.InstallationMediaConfigSpec.Cloud
	(*InstallationMediaConfigSpec_SBC)(nil),            // 184: specs.InstallationMediaConfigSpec.SBC
	nil,                                                // 185: specs.InstallationMediaConfigSpec.MachineLabelsEntry
	(*ClusterMachineSecretsSpec_Rotation)(nil),         // 186: specs.ClusterMachineSecretsSpec.Rotation
	nil, // 187: specs.UpgradeRolloutSpec.MachineSetsUpgradeQuotaEntry
	(*ClusterKubernetesManifestsStatusSpec_ManifestStatus)(nil), // 188: specs.ClusterKubernetesManifestsStatusSpec.ManifestStatus
	(*ClusterKubernetesManifestsStatusSpec_GroupStatus)(nil),    // 189: specs.ClusterKubernetesManifestsStatusSpec.GroupStatus
	nil, // 190: specs.ClusterKubernetesManifestsStatusSpec.GroupsEntry
	nil, // 191: specs.ClusterKubernetesManifestsStatusSpec.GroupStatus.ManifestsEntry
	(*MachineInstallDiskStatusSpec_Disk)(nil), // 192: specs.MachineInstallDiskStatusSpec.Disk
	(*durationpb.Duration)(nil),               // 193: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),             // 194: google.protobuf.Timestamp
	(*machine.MachineStatusEvent)(nil),        // 195: machine.MachineStatusEvent
	(PlatformConfigSpec_Arch)(0),              // 196: specs.PlatformConfigSpec.Arch
	(management.SchematicBootloader)(0),       // 197: management.SchematicBootloader
}
var file_omni_specs_omni_proto_depIdxs = []int32{
	4,   // 0: specs.SecurityState.fips_state:type_name -> specs.SecurityState.FIPSState
	141, // 1: specs.MachineStatusSpec.hardware:type_name -> specs.MachineStatusSpec.HardwareStatus
	142, // 2: specs.MachineStatusSpec.network:type_name -> specs.MachineStatusSpec.NetworkStatus
	5,   // 3: specs.MachineStatusSpec.role:type_name -> specs.MachineStatusSpec.Role
	143, // 4: specs.MachineStatusSpec.platform_metadata:type_name -> specs.MachineStatusSpec.PlatformMetadata
	146, // 5: specs.MachineStatusSpec.image_labels:type_name -> specs.MachineStatusSpec.ImageLabelsEntry
	144, // 6: specs.MachineStatusSpec.schematic:type_name -> specs.MachineStatusSpec.Schematic
	145, // 7: specs.MachineStatusSpec.diagnostics:type_name -> specs.MachineStatusSpec.Diagnostic
	6,   // 8: specs.MachineStatusSpec.power_state:type_name -> specs.MachineStatusSpec.PowerState
	31,  // 9: specs.MachineStatusSpec.security_state:type_name -> specs.SecurityState
	153, // 10: specs.ClusterSpec.features:type_name -> specs.ClusterSpec.Features
	38,  // 11: specs.ClusterSpec.backup_configuration:type_name -> specs.EtcdBackupConf
	193, // 12: specs.EtcdBackupConf.interval:type_name -> google.protobuf.Duration
	194, // 13: specs.EtcdBackupSpec.created_at:type_name -> google.protobuf.Timestamp
	193, // 14: specs.BackupDataSpec.interval:type_name -> google.protobuf.Duration
	7,   // 15: specs.EtcdBackupStatusSpec.status:type_name -> specs.EtcdBackupStatusSpec.Status
	194, // 16: specs.EtcdBackupStatusSpec.last_backup_time:type_name -> google.protobuf.Timestamp
	194, // 17: specs.EtcdBackupStatusSpec.last_backup_attempt:type_name -> google.protobuf.Timestamp
	194, // 18: specs.EtcdManualBackupSpec.backup_at:type_name -> google.protobuf.Timestamp
	44,  // 19: specs.EtcdBackupOverallStatusSpec.last_backup_status:type_name -> specs.EtcdBackupStatusSpec
	...
	154, // 22: specs.ClusterMachineStatusSpec.provision_status:type_name -> specs.ClusterMachineStatusSpec.ProvisionStatus
	55,  // 23: specs.ClusterStatusSpec.machines:type_name -> specs.Machines
	9,   // 24: specs.ClusterStatusSpec.phase:type_name -> specs.ClusterStatusSpec.Phase
	155, // 25: specs.MachinePendingUpdatesSpec.upgrade:type_name -> specs.MachinePendingUpdatesSpec.Upgrade
	156, // 26: specs.ClusterSecretsSpec.extra_certs:type_name -> specs.ClusterSecretsSpec.Certs
	10,  // 27: specs.MachineSetSpec.update_strategy:type_name -> specs.MachineSetSpec.UpdateStrategy
	159, // 28: specs.MachineSetSpec.machine_class:type_name -> specs.MachineSetSpec.MachineAllocation
	160, // 29: specs.MachineSetSpec.bootstrap_spec:type_name -> specs.MachineSetSpec.BootstrapSpec
	10,  // 30: specs.MachineSetSpec.delete_strategy:type_name -> specs.MachineSetSpec.UpdateStrategy
	162, // 31: specs.MachineSetSpec.update_strategy_config:type_name -> specs.MachineSetSpec.UpdateStrategyConfig
	162, // 32: specs.MachineSetSpec.delete_strategy_config:type_name -> specs.MachineSetSpec.UpdateStrategyConfig
	159, // 33: specs.MachineSetSpec.machine_allocation:type_name -> specs.MachineSetSpec.MachineAllocation
	10,  // 34: specs.MachineSetSpec.upgrade_strategy:type_name -> specs.MachineSetSpec.UpdateStrategy
	162, // 35: specs.MachineSetSpec.upgrade_strategy_config:type_name -> specs.MachineSetSpec.UpdateStrategyConfig
	...
	55,  // 38: specs.MachineSetStatusSpec.machines:type_name -> specs.Machines
	159, // 39: specs.MachineSetStatusSpec.machine_allocation:type_name -> specs.MachineSetSpec.MachineAllocation
	10,  // 40: specs.MachineSetConfigStatusSpec.update_strategy:type_name -> specs.MachineSetSpec.UpdateStrategy
	162, // 41: specs.MachineSetConfigStatusSpec.update_strategy_config:type_name -> specs.MachineSetSpec.UpdateStrategyConfig
	195, // 42: specs.MachineStatusSnapshotSpec.machine_status:type_name -> machine.MachineStatusEvent
	14,  // 43: specs.MachineStatusSnapshotSpec.power_stage:type_name -> specs.MachineStatusSnapshotSpec.PowerStage
	163, // 44: specs.ControlPlaneStatusSpec.conditions:type_name -> specs.ControlPlaneStatusSpec.Condition
	164, // 45: specs.KubernetesStatusSpec.nodes:type_name -> specs.KubernetesStatusSpec.NodeStatus
	166, // 46: specs.KubernetesStatusSpec.static_pods:type_name -> specs.KubernetesStatusSpec.NodeStaticPods
	17,  // 47: specs.KubernetesUpgradeStatusSpec.phase:type_name -> specs.KubernetesUpgradeStatusSpec.Phase
	71,  // 48: specs.OngoingTaskSpec.talos_upgrade:type_name -> specs.TalosUpgradeStatusSpec
	80,  // 49: specs.OngoingTaskSpec.kubernetes_upgrade:type_name -> specs.KubernetesUpgradeStatusSpec
	82,  // 50: specs.OngoingTaskSpec.destroy:type_name -> specs.DestroyStatusSpec
	106, // 51: specs.OngoingTaskSpec.machine_upgrade:type_name -> specs.MachineUpgradeStatusSpec
	129, // 52: specs.OngoingTaskSpec.secrets_rotation:type_name -> specs.ClusterSecretsRotationStatusSpec
	92,  // 53: specs.FeaturesConfigSpec.etcd_backup_settings:type_name -> specs.EtcdBackupSettings
	88,  // 54: specs.FeaturesConfigSpec.user_pilot_settings:type_name -> specs.UserPilotSettings
	90,  // 55: specs.FeaturesConfigSpec.stripe_settings:type_name -> specs.StripeSettings
	91,  // 56: specs.FeaturesConfigSpec.account:type_name -> specs.Account
	89,  // 57: specs.FeaturesConfigSpec.posthog_settings:type_name -> specs.PosthogSettings
	193, // 58: specs.EtcdBackupSettings.tick_interval:type_name -> google.protobuf.Duration
	193, // 59: specs.EtcdBackupSettings.min_interval:type_name -> google.protobuf.Duration
	193, // 60: specs.EtcdBackupSettings.max_interval:type_name -> google.protobuf.Duration
	167, // 61: specs.MachineClassSpec.auto_provision:type_name -> specs.MachineClassSpec.Provision
	168, // 62: specs.MachineConfigGenOptionsSpec.install_image:type_name -> specs.MachineConfigGenOptionsSpec.InstallImage
	169, // 63: specs.KubernetesUsageSpec.cpu:type_name -> specs.KubernetesUsageSpec.Quantity
	169, // 64: specs.KubernetesUsageSpec.mem:type_name -> specs.KubernetesUsageSpec.Quantity
	169, // 65: specs.KubernetesUsageSpec.storage:type_name -> specs.KubernetesUsageSpec.Quantity
	170, // 66: specs.KubernetesUsageSpec.pods:type_name -> specs.KubernetesUsageSpec.Pod
	171, // 67: specs.ImagePullRequestSpec.node_image_list:type_name -> specs.ImagePullRequestSpec.NodeImageList
	172, // 68: specs.TalosExtensionsSpec.items:type_name -> specs.TalosExtensionsSpec.Info
	18,  // 69: specs.MachineUpgradeStatusSpec.phase:type_name -> specs.MachineUpgradeStatusSpec.Phase
	173, // 70: specs.MachineExtensionsStatusSpec.extensions:type_name -> specs.MachineExtensionsStatusSpec.Item
	174, // 71: specs.MachineStatusMetricsSpec.platforms:type_name -> specs.MachineStatusMetricsSpec.PlatformsEntry
	175, // 72: specs.MachineStatusMetricsSpec.secure_boot_status:type_name -> specs.MachineStatusMetricsSpec.SecureBootStatusEntry
	176, // 73: specs.MachineStatusMetricsSpec.uki_status:type_name -> specs.MachineStatusMetricsSpec.UkiStatusEntry
	177, // 74: specs.ClusterMetricsSpec.features:type_name -> specs.ClusterMetricsSpec.FeaturesEntry
	178, // 75: specs.ClusterStatusMetricsSpec.phases:type_name -> specs.ClusterStatusMetricsSpec.PhasesEntry
	33,  // 76: specs.MachineRequestSetSpec.meta_values:type_name -> specs.MetaValue
	3,   // 77: specs.MachineRequestSetSpec.grpc_tunnel:type_name -> specs.GrpcTunnelMode
	179, // 78: specs.ClusterDiagnosticsSpec.nodes:type_name -> specs.ClusterDiagnosticsSpec.Node
	...
	180, // 82: specs.InfraMachineBMCConfigSpec.ipmi:type_name -> specs.InfraMachineBMCConfigSpec.IPMI
	181, // 83: specs.InfraMachineBMCConfigSpec.api:type_name -> specs.InfraMachineBMCConfigSpec.API
	182, // 84: specs.InfraProviderCombinedStatusSpec.health:type_name -> specs.InfraProviderCombinedStatusSpec.Health
	196, // 85: specs.InstallationMediaConfigSpec.architecture:type_name -> specs.PlatformConfigSpec.Arch
	183, // 86: specs.InstallationMediaConfigSpec.cloud:type_name -> specs.InstallationMediaConfigSpec.Cloud
	184, // 87: specs.InstallationMediaConfigSpec.sbc:type_name -> specs.InstallationMediaConfigSpec.SBC
	3,   // 88: specs.InstallationMediaConfigSpec.grpc_tunnel:type_name -> specs.GrpcTunnelMode
	185, // 89: specs.InstallationMediaConfigSpec.machine_labels:type_name -> specs.InstallationMediaConfigSpec.MachineLabelsEntry
	197, // 90: specs.InstallationMediaConfigSpec.bootloader:type_name -> management.SchematicBootloader
	...
	156, // 94: specs.SecretRotationSpec.certs:type_name -> specs.ClusterSecretsSpec.Certs
	156, // 95: specs.SecretRotationSpec.extra_certs:type_name -> specs.ClusterSecretsSpec.Certs
	157, // 96: specs.SecretRotationSpec.backup_certs_os:type_name -> specs.ClusterSecretsSpec.Certs.CA
	157, // 97: specs.SecretRotationSpec.backup_certs_k8s:type_name -> specs.ClusterSecretsSpec.Certs.CA
	...
	186, // 100: specs.ClusterMachineSecretsSpec.rotation:type_name -> specs.ClusterMachineSecretsSpec.Rotation
	187, // 101: specs.UpgradeRolloutSpec.machine_sets_upgrade_quota:type_name -> specs.UpgradeRolloutSpec.MachineSetsUpgradeQuotaEntry
	...
	190, // 104: specs.ClusterKubernetesManifestsStatusSpec.groups:type_name -> specs.ClusterKubernetesManifestsStatusSpec.GroupsEntry
	193, // 105: specs.KubernetesHealthCheckSpec.interval:type_name -> google.protobuf.Duration
	192, // 106: specs.MachineInstallDiskStatusSpec.disks:type_name -> specs.MachineInstallDiskStatusSpec.Disk
	147, // 107: specs.MachineStatusSpec.HardwareStatus.processors:type_name -> specs.MachineStatusSpec.HardwareStatus.Processor
	148, // 108: specs.MachineStatusSpec.HardwareStatus.memory_modules:type_name -> specs.MachineStatusSpec.HardwareStatus.MemoryModule
	149, // 109: specs.MachineStatusSpec.HardwareStatus.blockdevices:type_name -> specs.MachineStatusSpec.HardwareStatus.BlockDevice
	150, // 110: specs.MachineStatusSpec.NetworkStatus.network_links:type_name -> specs.MachineStatusSpec.NetworkStatus.NetworkLinkStatus
	151, // 111: specs.MachineStatusSpec.PlatformMetadata.tags:type_name -> specs.MachineStatusSpec.PlatformMetadata.TagsEntry
	152, // 112: specs.MachineStatusSpec.Schematic.initial_state:type_name -> specs.MachineStatusSpec.Schematic.InitialState
	157, // 113: specs.ClusterSecretsSpec.Certs.os:type_name -> specs.ClusterSecretsSpec.Certs.CA
	157, // 114: specs.ClusterSecretsSpec.Certs.k8s:type_name -> specs.ClusterSecretsSpec.Certs.CA
	11,  // 115: specs.MachineSetSpec.MachineClass.allocation_type:type_name -> specs.MachineSetSpec.MachineClass.Type
	12,  // 116: specs.MachineSetSpec.MachineAllocation.allocation_type:type_name -> specs.MachineSetSpec.MachineAllocation.Type
	161, // 117: specs.MachineSetSpec.UpdateStrategyConfig.rolling:type_name -> specs.MachineSetSpec.RollingUpdateStrategyConfig
	2,   // 118: specs.ControlPlaneStatusSpec.Condition.type:type_name -> specs.ConditionType
	15,  // 119: specs.ControlPlaneStatusSpec.Condition.status:type_name -> specs.ControlPlaneStatusSpec.Condition.Status
	16,  // 120: specs.ControlPlaneStatusSpec.Condition.severity:type_name -> specs.ControlPlaneStatusSpec.Condition.Severity
	165, // 121: specs.KubernetesStatusSpec.NodeStaticPods.static_pods:type_name -> specs.KubernetesStatusSpec.StaticPodStatus
	33,  // 122: specs.MachineClassSpec.Provision.meta_values:type_name -> specs.MetaValue
	3,   // 123: specs.MachineClassSpec.Provision.grpc_tunnel:type_name -> specs.GrpcTunnelMode
	31,  // 124: specs.MachineConfigGenOptionsSpec.InstallImage.security_state:type_name -> specs.SecurityState
	19,  // 125: specs.MachineExtensionsStatusSpec.Item.phase:type_name -> specs.MachineExtensionsStatusSpec.Item.Phase
	23,  // 126: specs.ClusterMachineSecretsSpec.Rotation.status:type_name -> specs.SecretRotationSpec.Status
	24,  // 127: specs.ClusterMachineSecretsSpec.Rotation.phase:type_name -> specs.SecretRotationSpec.Phase
	25,  // 128: specs.ClusterMachineSecretsSpec.Rotation.component:type_name -> specs.SecretRotationSpec.Component
	156, // 129: specs.ClusterMachineSecretsSpec.Rotation.extra_certs:type_name -> specs.ClusterSecretsSpec.Certs
	28,  // 130: specs.ClusterKubernetesManifestsStatusSpec.ManifestStatus.phase:type_name -> specs.ClusterKubernetesManifestsStatusSpec.ManifestStatus.Phase
	29,  // 131: specs.ClusterKubernetesManifestsStatusSpec.GroupStatus.phase:type_name -> specs.ClusterKubernetesManifestsStatusSpec.GroupStatus.Phase
	27,  // 132: specs.ClusterKubernetesManifestsStatusSpec.GroupStatus.mode:type_name -> specs.KubernetesManifestGroupSpec.Mode
	191, // 133: specs.ClusterKubernetesManifestsStatusSpec.GroupStatus.manifests:type_name -> specs.ClusterKubernetesManifestsStatusSpec.GroupStatus.ManifestsEntry
	189, // 134: specs.ClusterKubernetesManifestsStatusSpec.GroupsEntry.value:type_name -> specs.ClusterKubernetesManifestsStatusSpec.GroupStatus
	188, // 135: specs.ClusterKubernetesManifestsStatusSpec.GroupStatus.ManifestsEntry.value:type_name -> specs.ClusterKubernetesManifestsStatusSpec.ManifestStatus
...
func file_omni_specs_omni_proto_init() {
	...
	file_omni_specs_omni_proto_msgTypes[53].OneofWrappers = []any{
		...
		(*OngoingTaskSpec_SecretsRotation)(nil),
	}
	type x struct{}
