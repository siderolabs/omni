...
const (
	...
	ClusterKubernetesManifestsStatusSpec_ManifestStatus_APPLIED ClusterKubernetesManifestsStatusSpec_ManifestStatus_Phase = 1
	ClusterKubernetesManifestsStatusSpec_ManifestStatus_FAILED  ClusterKubernetesManifestsStatusSpec_ManifestStatus_Phase = 2
)
...
const file_omni_specs_omni_proto_rawDesc = "" +
	...
	"\fbootstrapped\x18\x01 \x01(\bR\fbootstrapped\"\xed\x01\n" +
	...
	"extraCerts\x1ae\n" +
	"\x05Certs\x122\n" +
	"\x02os\x18\x01 \x01(\v2\".specs.ClusterSecretsSpec.Certs.CAR\x02os\x1a(\n" +
	"\x02CA\x12\x10\n" +
	...
	"extraCerts\x12J\n" +
	"\x0fbackup_certs_os\x18\x06 \x03(\v2\".specs.ClusterSecretsSpec.Certs.CAR\rbackupCertsOs\"#\n" +
	"\x06Status\x12\b\n" +
	...
	"\x06errors\x18\x02 \x03(\v27.specs.ClusterKubernetesManifestsStatusSpec.ErrorsEntryR\x06errors\x1a\xee\x01\n" +
	...
	"\x04mode\x18\x03 \x01(\x0e2\".specs.KubernetesManifestSpec.ModeR\x04mode\"-\n" +
	"\x05Phase\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\v\n" +
	"\aAPPLIED\x10\x01\x12\n" +
	"\n" +
	"\x06FAILED\x10\x02\x1ax\n" +
