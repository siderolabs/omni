...
var file_omni_specs_omni_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x2a, 0x46, 0x0a, 0x11, 0x43, 0x6f,
...
var file_omni_specs_omni_proto_msgTypes = make([]protoimpl.MessageInfo, 114)
var file_omni_specs_omni_proto_goTypes = []any{
	...
	(*MachineStatusSpec_HardwareStatus)(nil),                  // 105: specs.MachineStatusSpec.HardwareStatus
	(*MachineStatusSpec_NetworkStatus)(nil),                   // 106: specs.MachineStatusSpec.NetworkStatus
	(*MachineStatusSpec_PlatformMetadata)(nil),                // 107: specs.MachineStatusSpec.PlatformMetadata
	(*MachineStatusSpec_Schematic)(nil),                       // 108: specs.MachineStatusSpec.Schematic
	(*MachineStatusSpec_Diagnostic)(nil),                      // 109: specs.MachineStatusSpec.Diagnostic
	nil,                                                       // 110: specs.MachineStatusSpec.ImageLabelsEntry
	(*MachineStatusSpec_HardwareStatus_Processor)(nil),        // 111: specs.MachineStatusSpec.HardwareStatus.Processor
	(*MachineStatusSpec_HardwareStatus_MemoryModule)(nil),     // 112: specs.MachineStatusSpec.HardwareStatus.MemoryModule
	(*MachineStatusSpec_HardwareStatus_BlockDevice)(nil),      // 113: specs.MachineStatusSpec.HardwareStatus.BlockDevice
	(*MachineStatusSpec_NetworkStatus_NetworkLinkStatus)(nil), // 114: specs.MachineStatusSpec.NetworkStatus.NetworkLinkStatus
	(*ClusterSpec_Features)(nil),                              // 115: specs.ClusterSpec.Features
	(*ClusterMachineStatusSpec_ProvisionStatus)(nil),          // 116: specs.ClusterMachineStatusSpec.ProvisionStatus
	(*MachineSetSpec_MachineClass)(nil),                       // 117: specs.MachineSetSpec.MachineClass
	(*MachineSetSpec_MachineAllocation)(nil),                  // 118: specs.MachineSetSpec.MachineAllocation
	(*MachineSetSpec_BootstrapSpec)(nil),                      // 119: specs.MachineSetSpec.BootstrapSpec
	(*MachineSetSpec_RollingUpdateStrategyConfig)(nil),        // 120: specs.MachineSetSpec.RollingUpdateStrategyConfig
	(*MachineSetSpec_UpdateStrategyConfig)(nil),               // 121: specs.MachineSetSpec.UpdateStrategyConfig
	(*ControlPlaneStatusSpec_Condition)(nil),                  // 122: specs.ControlPlaneStatusSpec.Condition
	(*KubernetesStatusSpec_NodeStatus)(nil),                   // 123: specs.KubernetesStatusSpec.NodeStatus
	(*KubernetesStatusSpec_StaticPodStatus)(nil),              // 124: specs.KubernetesStatusSpec.StaticPodStatus
	(*KubernetesStatusSpec_NodeStaticPods)(nil),               // 125: specs.KubernetesStatusSpec.NodeStaticPods
	(*MachineClassSpec_Provision)(nil),                        // 126: specs.MachineClassSpec.Provision
	(*MachineConfigGenOptionsSpec_InstallImage)(nil),          // 127: specs.MachineConfigGenOptionsSpec.InstallImage
	(*KubernetesUsageSpec_Quantity)(nil),                      // 128: specs.KubernetesUsageSpec.Quantity
	(*KubernetesUsageSpec_Pod)(nil),                           // 129: specs.KubernetesUsageSpec.Pod
	(*ImagePullRequestSpec_NodeImageList)(nil),                // 130: specs.ImagePullRequestSpec.NodeImageList
	(*TalosExtensionsSpec_Info)(nil),                          // 131: specs.TalosExtensionsSpec.Info
	(*MachineExtensionsStatusSpec_Item)(nil),                  // 132: specs.MachineExtensionsStatusSpec.Item
	nil,                                                       // 133: specs.ClusterStatusMetricsSpec.PhasesEntry
	(*ClusterDiagnosticsSpec_Node)(nil),                       // 134: specs.ClusterDiagnosticsSpec.Node
	(*InfraMachineBMCConfigSpec_IPMI)(nil),                    // 135: specs.InfraMachineBMCConfigSpec.IPMI
	(*InfraMachineBMCConfigSpec_API)(nil),                     // 136: specs.InfraMachineBMCConfigSpec.API
	(*durationpb.Duration)(nil),                               // 137: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),                             // 138: google.protobuf.Timestamp
	(*machine.MachineStatusEvent)(nil),                        // 139: machine.MachineStatusEvent
}
var file_omni_specs_omni_proto_depIdxs = []int32{
	105, // 0: specs.MachineStatusSpec.hardware:type_name -> specs.MachineStatusSpec.HardwareStatus
	106, // 1: specs.MachineStatusSpec.network:type_name -> specs.MachineStatusSpec.NetworkStatus
	4,   // 2: specs.MachineStatusSpec.role:type_name -> specs.MachineStatusSpec.Role
	107, // 3: specs.MachineStatusSpec.platform_metadata:type_name -> specs.MachineStatusSpec.PlatformMetadata
	110, // 4: specs.MachineStatusSpec.image_labels:type_name -> specs.MachineStatusSpec.ImageLabelsEntry
	108, // 5: specs.MachineStatusSpec.schematic:type_name -> specs.MachineStatusSpec.Schematic
	24,  // 6: specs.MachineStatusSpec.secure_boot_status:type_name -> specs.SecureBootStatus
	109, // 7: specs.MachineStatusSpec.diagnostics:type_name -> specs.MachineStatusSpec.Diagnostic
	5,   // 8: specs.MachineStatusSpec.power_state:type_name -> specs.MachineStatusSpec.PowerState
	115, // 9: specs.ClusterSpec.features:type_name -> specs.ClusterSpec.Features
	31,  // 10: specs.ClusterSpec.backup_configuration:type_name -> specs.EtcdBackupConf
	137, // 11: specs.EtcdBackupConf.interval:type_name -> google.protobuf.Duration
	138, // 12: specs.EtcdBackupSpec.created_at:type_name -> google.protobuf.Timestamp
	137, // 13: specs.BackupDataSpec.interval:type_name -> google.protobuf.Duration
	6,   // 14: specs.EtcdBackupStatusSpec.status:type_name -> specs.EtcdBackupStatusSpec.Status
	138, // 15: specs.EtcdBackupStatusSpec.last_backup_time:type_name -> google.protobuf.Timestamp
	138, // 16: specs.EtcdBackupStatusSpec.last_backup_attempt:type_name -> google.protobuf.Timestamp
	138, // 17: specs.EtcdManualBackupSpec.backup_at:type_name -> google.protobuf.Timestamp
	...
	116, // 21: specs.ClusterMachineStatusSpec.provision_status:type_name -> specs.ClusterMachineStatusSpec.ProvisionStatus
	...
	118, // 25: specs.MachineSetSpec.machine_class:type_name -> specs.MachineSetSpec.MachineAllocation
	119, // 26: specs.MachineSetSpec.bootstrap_spec:type_name -> specs.MachineSetSpec.BootstrapSpec
	9,   // 27: specs.MachineSetSpec.delete_strategy:type_name -> specs.MachineSetSpec.UpdateStrategy
	121, // 28: specs.MachineSetSpec.update_strategy_config:type_name -> specs.MachineSetSpec.UpdateStrategyConfig
	121, // 29: specs.MachineSetSpec.delete_strategy_config:type_name -> specs.MachineSetSpec.UpdateStrategyConfig
	118, // 30: specs.MachineSetSpec.machine_allocation:type_name -> specs.MachineSetSpec.MachineAllocation
	...
	118, // 34: specs.MachineSetStatusSpec.machine_allocation:type_name -> specs.MachineSetSpec.MachineAllocation
	139, // 35: specs.MachineStatusSnapshotSpec.machine_status:type_name -> machine.MachineStatusEvent
	14,  // 36: specs.MachineStatusSnapshotSpec.power_stage:type_name -> specs.MachineStatusSnapshotSpec.PowerStage
	122, // 37: specs.ControlPlaneStatusSpec.conditions:type_name -> specs.ControlPlaneStatusSpec.Condition
	123, // 38: specs.KubernetesStatusSpec.nodes:type_name -> specs.KubernetesStatusSpec.NodeStatus
	125, // 39: specs.KubernetesStatusSpec.static_pods:type_name -> specs.KubernetesStatusSpec.NodeStaticPods
	...
	137, // 45: specs.EtcdBackupSettings.tick_interval:type_name -> google.protobuf.Duration
	137, // 46: specs.EtcdBackupSettings.min_interval:type_name -> google.protobuf.Duration
	137, // 47: specs.EtcdBackupSettings.max_interval:type_name -> google.protobuf.Duration
	126, // 48: specs.MachineClassSpec.auto_provision:type_name -> specs.MachineClassSpec.Provision
	127, // 49: specs.MachineConfigGenOptionsSpec.install_image:type_name -> specs.MachineConfigGenOptionsSpec.InstallImage
	128, // 50: specs.KubernetesUsageSpec.cpu:type_name -> specs.KubernetesUsageSpec.Quantity
	128, // 51: specs.KubernetesUsageSpec.mem:type_name -> specs.KubernetesUsageSpec.Quantity
	128, // 52: specs.KubernetesUsageSpec.storage:type_name -> specs.KubernetesUsageSpec.Quantity
	129, // 53: specs.KubernetesUsageSpec.pods:type_name -> specs.KubernetesUsageSpec.Pod
	130, // 54: specs.ImagePullRequestSpec.node_image_list:type_name -> specs.ImagePullRequestSpec.NodeImageList
	131, // 55: specs.TalosExtensionsSpec.items:type_name -> specs.TalosExtensionsSpec.Info
	18,  // 56: specs.ExtensionsConfigurationStatusSpec.phase:type_name -> specs.ExtensionsConfigurationStatusSpec.Phase
	132, // 57: specs.MachineExtensionsStatusSpec.extensions:type_name -> specs.MachineExtensionsStatusSpec.Item
	133, // 58: specs.ClusterStatusMetricsSpec.phases:type_name -> specs.ClusterStatusMetricsSpec.PhasesEntry
	...
	134, // 61: specs.ClusterDiagnosticsSpec.nodes:type_name -> specs.ClusterDiagnosticsSpec.Node
	...
	135, // 65: specs.InfraMachineBMCConfigSpec.ipmi:type_name -> specs.InfraMachineBMCConfigSpec.IPMI
	136, // 66: specs.InfraMachineBMCConfigSpec.api:type_name -> specs.InfraMachineBMCConfigSpec.API
	111, // 67: specs.MachineStatusSpec.HardwareStatus.processors:type_name -> specs.MachineStatusSpec.HardwareStatus.Processor
	112, // 68: specs.MachineStatusSpec.HardwareStatus.memory_modules:type_name -> specs.MachineStatusSpec.HardwareStatus.MemoryModule
	113, // 69: specs.MachineStatusSpec.HardwareStatus.blockdevices:type_name -> specs.MachineStatusSpec.HardwareStatus.BlockDevice
	114, // 70: specs.MachineStatusSpec.NetworkStatus.network_links:type_name -> specs.MachineStatusSpec.NetworkStatus.NetworkLinkStatus
	...
	120, // 76: specs.MachineSetSpec.UpdateStrategyConfig.rolling:type_name -> specs.MachineSetSpec.RollingUpdateStrategyConfig
	...
	124, // 80: specs.KubernetesStatusSpec.NodeStaticPods.static_pods:type_name -> specs.KubernetesStatusSpec.StaticPodStatus
