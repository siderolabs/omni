...
var file_omni_specs_omni_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x10, 0x02, 0x2a, 0x46, 0x0a, 0x11, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x41, 0x70,
...
var file_omni_specs_omni_proto_msgTypes = make([]protoimpl.MessageInfo, 87)
var file_omni_specs_omni_proto_goTypes = []interface{}{
	...
	(*MachineStatusSpec_HardwareStatus)(nil),        // 78: specs.MachineStatusSpec.HardwareStatus
	(*MachineStatusSpec_NetworkStatus)(nil),         // 79: specs.MachineStatusSpec.NetworkStatus
	(*MachineStatusSpec_PlatformMetadata)(nil),      // 80: specs.MachineStatusSpec.PlatformMetadata
	(*MachineStatusSpec_Schematic)(nil),             // 81: specs.MachineStatusSpec.Schematic
	(*MachineStatusSpec_MaintenanceConfig)(nil),     // 82: specs.MachineStatusSpec.MaintenanceConfig
	nil, // 83: specs.MachineStatusSpec.ImageLabelsEntry
	(*MachineStatusSpec_HardwareStatus_Processor)(nil),        // 84: specs.MachineStatusSpec.HardwareStatus.Processor
	(*MachineStatusSpec_HardwareStatus_MemoryModule)(nil),     // 85: specs.MachineStatusSpec.HardwareStatus.MemoryModule
	(*MachineStatusSpec_HardwareStatus_BlockDevice)(nil),      // 86: specs.MachineStatusSpec.HardwareStatus.BlockDevice
	(*MachineStatusSpec_NetworkStatus_NetworkLinkStatus)(nil), // 87: specs.MachineStatusSpec.NetworkStatus.NetworkLinkStatus
	(*ClusterSpec_Features)(nil),                              // 88: specs.ClusterSpec.Features
	(*MachineSetSpec_MachineClass)(nil),                       // 89: specs.MachineSetSpec.MachineClass
	(*MachineSetSpec_BootstrapSpec)(nil),                      // 90: specs.MachineSetSpec.BootstrapSpec
	(*MachineSetSpec_RollingUpdateStrategyConfig)(nil),        // 91: specs.MachineSetSpec.RollingUpdateStrategyConfig
	(*MachineSetSpec_UpdateStrategyConfig)(nil),               // 92: specs.MachineSetSpec.UpdateStrategyConfig
	(*ControlPlaneStatusSpec_Condition)(nil),                  // 93: specs.ControlPlaneStatusSpec.Condition
	(*KubernetesStatusSpec_NodeStatus)(nil),                   // 94: specs.KubernetesStatusSpec.NodeStatus
	(*KubernetesStatusSpec_StaticPodStatus)(nil),              // 95: specs.KubernetesStatusSpec.StaticPodStatus
	(*KubernetesStatusSpec_NodeStaticPods)(nil),               // 96: specs.KubernetesStatusSpec.NodeStaticPods
	(*KubernetesUsageSpec_Quantity)(nil),                      // 97: specs.KubernetesUsageSpec.Quantity
	(*KubernetesUsageSpec_Pod)(nil),                           // 98: specs.KubernetesUsageSpec.Pod
	(*ImagePullRequestSpec_NodeImageList)(nil),                // 99: specs.ImagePullRequestSpec.NodeImageList
	(*TalosExtensionsSpec_Info)(nil),                          // 100: specs.TalosExtensionsSpec.Info
	(*durationpb.Duration)(nil),                               // 101: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),                             // 102: google.protobuf.Timestamp
	(*machine.MachineStatusEvent)(nil),                        // 103: machine.MachineStatusEvent
}
var file_omni_specs_omni_proto_depIdxs = []int32{
	78,  // 0: specs.MachineStatusSpec.hardware:type_name -> specs.MachineStatusSpec.HardwareStatus
	79,  // 1: specs.MachineStatusSpec.network:type_name -> specs.MachineStatusSpec.NetworkStatus
	3,   // 2: specs.MachineStatusSpec.role:type_name -> specs.MachineStatusSpec.Role
	80,  // 3: specs.MachineStatusSpec.platform_metadata:type_name -> specs.MachineStatusSpec.PlatformMetadata
	83,  // 4: specs.MachineStatusSpec.image_labels:type_name -> specs.MachineStatusSpec.ImageLabelsEntry
	81,  // 5: specs.MachineStatusSpec.schematic:type_name -> specs.MachineStatusSpec.Schematic
	82,  // 6: specs.MachineStatusSpec.maintenance_config:type_name -> specs.MachineStatusSpec.MaintenanceConfig
	88,  // 7: specs.ClusterSpec.features:type_name -> specs.ClusterSpec.Features
	18,  // 8: specs.ClusterSpec.backup_configuration:type_name -> specs.EtcdBackupConf
	101, // 9: specs.EtcdBackupConf.interval:type_name -> google.protobuf.Duration
	102, // 10: specs.EtcdBackupSpec.created_at:type_name -> google.protobuf.Timestamp
	101, // 11: specs.BackupDataSpec.interval:type_name -> google.protobuf.Duration
	4,   // 12: specs.EtcdBackupStatusSpec.status:type_name -> specs.EtcdBackupStatusSpec.Status
	102, // 13: specs.EtcdBackupStatusSpec.last_backup_time:type_name -> google.protobuf.Timestamp
	102, // 14: specs.EtcdBackupStatusSpec.last_backup_attempt:type_name -> google.protobuf.Timestamp
	102, // 15: specs.EtcdManualBackupSpec.backup_at:type_name -> google.protobuf.Timestamp
	...
	89,  // 22: specs.MachineSetSpec.machine_class:type_name -> specs.MachineSetSpec.MachineClass
	90,  // 23: specs.MachineSetSpec.bootstrap_spec:type_name -> specs.MachineSetSpec.BootstrapSpec
	7,   // 24: specs.MachineSetSpec.delete_strategy:type_name -> specs.MachineSetSpec.UpdateStrategy
	92,  // 25: specs.MachineSetSpec.update_strategy_config:type_name -> specs.MachineSetSpec.UpdateStrategyConfig
	92,  // 26: specs.MachineSetSpec.delete_strategy_config:type_name -> specs.MachineSetSpec.UpdateStrategyConfig
	...
	89,  // 30: specs.MachineSetStatusSpec.machine_class:type_name -> specs.MachineSetSpec.MachineClass
	103, // 31: specs.MachineStatusSnapshotSpec.machine_status:type_name -> machine.MachineStatusEvent
	93,  // 32: specs.ControlPlaneStatusSpec.conditions:type_name -> specs.ControlPlaneStatusSpec.Condition
	94,  // 33: specs.KubernetesStatusSpec.nodes:type_name -> specs.KubernetesStatusSpec.NodeStatus
	96,  // 34: specs.KubernetesStatusSpec.static_pods:type_name -> specs.KubernetesStatusSpec.NodeStaticPods
	...
	101, // 40: specs.EtcdBackupSettings.tick_interval:type_name -> google.protobuf.Duration
	101, // 41: specs.EtcdBackupSettings.min_interval:type_name -> google.protobuf.Duration
	101, // 42: specs.EtcdBackupSettings.max_interval:type_name -> google.protobuf.Duration
	97,  // 43: specs.KubernetesUsageSpec.cpu:type_name -> specs.KubernetesUsageSpec.Quantity
	97,  // 44: specs.KubernetesUsageSpec.mem:type_name -> specs.KubernetesUsageSpec.Quantity
	97,  // 45: specs.KubernetesUsageSpec.storage:type_name -> specs.KubernetesUsageSpec.Quantity
	98,  // 46: specs.KubernetesUsageSpec.pods:type_name -> specs.KubernetesUsageSpec.Pod
	99,  // 47: specs.ImagePullRequestSpec.node_image_list:type_name -> specs.ImagePullRequestSpec.NodeImageList
	100, // 48: specs.TalosExtensionsSpec.items:type_name -> specs.TalosExtensionsSpec.Info
	13,  // 49: specs.ExtensionsConfigurationStatusSpec.phase:type_name -> specs.ExtensionsConfigurationStatusSpec.Phase
	84,  // 50: specs.MachineStatusSpec.HardwareStatus.processors:type_name -> specs.MachineStatusSpec.HardwareStatus.Processor
	85,  // 51: specs.MachineStatusSpec.HardwareStatus.memory_modules:type_name -> specs.MachineStatusSpec.HardwareStatus.MemoryModule
	86,  // 52: specs.MachineStatusSpec.HardwareStatus.blockdevices:type_name -> specs.MachineStatusSpec.HardwareStatus.BlockDevice
	87,  // 53: specs.MachineStatusSpec.NetworkStatus.network_links:type_name -> specs.MachineStatusSpec.NetworkStatus.NetworkLinkStatus
	8,   // 54: specs.MachineSetSpec.MachineClass.allocation_type:type_name -> specs.MachineSetSpec.MachineClass.AllocationType
	91,  // 55: specs.MachineSetSpec.UpdateStrategyConfig.rolling:type_name -> specs.MachineSetSpec.RollingUpdateStrategyConfig
	...
	95,  // 59: specs.KubernetesStatusSpec.NodeStaticPods.static_pods:type_name -> specs.KubernetesStatusSpec.StaticPodStatus
