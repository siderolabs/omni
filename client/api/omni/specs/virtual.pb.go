...
func file_omni_specs_virtual_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_omni_specs_virtual_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_omni_specs_virtual_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
