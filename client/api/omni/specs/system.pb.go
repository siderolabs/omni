...
func file_omni_specs_system_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_omni_specs_system_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_omni_specs_system_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_omni_specs_system_proto_msgTypes[2].Exporter = func(v any, i int) any {
