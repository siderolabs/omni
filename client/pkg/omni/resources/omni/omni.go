...
func init() {
	...
	registry.MustRegisterResource(ClusterMachineExtendedConfigType, &ClusterMachineExtendedConfig{})
	...
	registry.MustRegisterResource(ClusterOperationStatusType, &ClusterOperationStatus{})
