...
//
// A resource comes from the API, so its ID, its spec and even the print columns
// of its definition are untrusted. The JSON and YAML encoders escape control
...
func NewWriter(format string, out io.Writer) (Writer, error) { //nolint:ireturn
