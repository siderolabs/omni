...
require (
	...
	github.com/siderolabs/discovery-service v1.1.0
...
replace github.com/cosi-project/state-etcd => github.com/smira/state-etcd v0.0.0-20260803154600-abed9e9567f0
