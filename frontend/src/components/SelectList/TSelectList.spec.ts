...
test('allows selection', async () => {
  ...
  await expect.element(trigger).toHaveTextContent('My select')
  ...
  // Cannot check aria-selected after selection — Reka UI closes the dropdown and removes options from the DOM
})
