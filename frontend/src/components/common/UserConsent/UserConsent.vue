...
import { Tracking, trackingState } from '@/methods/features'
...
const enableTracking = async () => {
  ...
  trackingState.value = Tracking.Enabled
...
<template>
  <div v-if="!trackingState && trackerToken">
        ...
        <div class="flex items-center justify-between">
          <p class="text-sm">
            ...
            <a
              ...
              href="http://siderolabs.com/omni-cookie-policy"
              target="_blank"
            >
              Learn more
            </a>
          ...
          <div class="flex gap-2">
            <TButton @click="trackingState = Tracking.Disabled">Decline</TButton>
