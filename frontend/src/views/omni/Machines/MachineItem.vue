...
<template>
  <t-list-item>
    <template #default>
      <div
        class="flex text-naturals-N13 text-xs items-center"
        ...
        <div class="flex gap-1" v-else>
          ...
          <div class="flex justify-end">
            <t-actions-box style="height: 24px">
              <t-actions-box-item icon="settings" @click="openConfigPatches"
                >Config Patches</t-actions-box-item
              >
              <t-actions-box-item icon="log" @click="machineLogs" v-if="canReadMachineLogs"
                >Logs</t-actions-box-item
              >
              <t-actions-box-item icon="copy" @click="copyMachineID"
                >Copy Machine ID</t-actions-box-item
              >
              <t-actions-box-item
                icon="overview"
                @click="showCluster"
                v-if="clusterName && canReadClusters"
                >Show Cluster</t-actions-box-item
              >
              <t-actions-box-item
                icon="delete"
                danger
                ...
                >Remove Machine</t-actions-box-item
              >
            </t-actions-box>
          </div>
        </div>
