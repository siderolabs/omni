  ...
  <div class="flex flex-col gap-4">
    ...
    <template v-else>
      <div class="flex flex-col gap-2">
        ...
        <div class="flex gap-2 text-xs items-center" v-if="infraProviders.length > 0">
          <span>Machine Class Type:</span>
          <t-button-group v-model="machineClassMode" :options="machineClassModeOptions" />
        </div>
      ...
      <div
        class="sticky -bottom-6 -my-6 -mx-6 bg-naturals-N1 border-t border-naturals-N5 h-16 flex items-center gap-2 px-12 py-6 text-xs justify-end"
      >
