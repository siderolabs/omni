...
<template>
  <div>
    <radio-group
      ...
      :modelValue="machineSetIndex"
      @update:modelValue="(value) => emit('update:machineSetIndex', value)"
      ...
      >
        <div @click="() => onSelect(index)">
          ...
          >
            ...
            <div class="relative">
              <machine-set-label
                class="opacity-75 hover:opacity-100 transition-opacity machine-set-label"
                :color="option.color"
                :class="{
    ...
    <div v-else class="flex items-center justify-center bg-naturals-N3 rounded relative h-8">
      <popper :show="showPicker" placement="left" v-click-outside="() => (showPicker = false)">
        <template #content>
              ...
              >
                <div @click="() => onSelect(checked)">
                  ...
                  >
                    <template #content>
                      <div
                        class="rounded px-4 py-2 text-naturals-N10 bg-naturals-N4 drop-shadow w-48"
                      >
                        {{ option.tooltip }}
                      </div>
                    </template>
        ...
        <div
          class="h-6 px-1 flex gap-1 items-center"
        ...
        >
          <t-icon
            icon="arrow-left"
            class="w-3 mx-1 h-3 text-naturals-N7 transition-all"
