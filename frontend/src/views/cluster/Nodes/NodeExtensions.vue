...
<template>
  <div class="flex flex-col flex-1">
          ...
          <t-list-item v-for="item in extensionsState" :key="item.name">
            <div class="flex gap-2 px-3">
              <div class="list-grid text-naturals-N12 flex-1">
                ...
                <div class="flex">
                  <div
                    class="flex gap-2 bg-naturals-N3 text-naturals-N13 rounded px-2 py-1 items-center text-xs"
                  >
    ...
    <div
      class="sticky -bottom-6 -my-6 -mx-6 bg-naturals-N1 border-t border-naturals-N5 h-16 flex items-center justify-end gap-2 px-12 py-6 text-xs"
    >
      <t-button type="highlighted" @click="openExtensionsUpdate" :disabled="!canUpdateTalos">
        Update Extensions
      </t-button>
    </div>
  </div>
