...
import ServiceAccountCreateModal from './ServiceAccountCreateModal.vue'

const meta: Meta<typeof ServiceAccountCreateModal> = {
  component: ServiceAccountCreateModal,
  args: {
    open: true,
    'onUpdate:open': fn(),
  },
