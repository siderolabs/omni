...
export const DefaultKubernetesVersion = "1.33.3";
...
export const DefaultTalosVersion = "1.10.6";
...
export const ExtraKernelArgsConfigurationType = "ExtraKernelArgsConfigurations.omni.sidero.dev";
...
export const ExtraKernelArgsConfigurationLabel = "omni.sidero.dev/root-configuration";
...
export const MachineExtraKernelArgsType = "MachineExtraKernelArgs.omni.sidero.dev";
export const MachineExtraKernelArgsStatusType = "MachineExtraKernelArgsStatuses.omni.sidero.dev";
