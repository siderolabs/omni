...
export const DefaultKubernetesVersion = "1.36.4";
...
export const DefaultTalosVersion = "1.13.10";
export const MinTalosVersion = "1.9.0";
export const LatestSupportedTalosVersion = "1.14";
...
export const TalosSystemInformationType = "SystemInformations.hardware.talos.dev";
export const TalosKubeSpanPeerStatusType = "KubeSpanPeerStatuses.kubespan.talos.dev";
export const TalosKubeSpanConfigType = "KubeSpanConfigs.kubespan.talos.dev";
...
export const TalosSystemInformationID = "systeminformation";
export const TalosKubespanConfigID = "kubespan";
export const TalosConfigNamespace = "config";
...
export const ClusterKubernetesManifestsStatusType = "ClusterKubernetesManifestsStatuses.omni.sidero.dev";
...
export const MachineStatusLabelEnterprise = "omni.sidero.dev/enterprise";
export const MachineStatusLabelFIPS = "omni.sidero.dev/fips";
...
export const MachineInstallDiskConfigType = "MachineInstallDiskConfigs.omni.sidero.dev";
export const MachineInstallDiskStatusType = "MachineInstallDiskStatuses.omni.sidero.dev";
...
export const EulaAcceptanceID = "eula";
export const EulaAcceptanceType = "EulaAcceptances.omni.sidero.dev";
export const IdentityType = "Identities.omni.sidero.dev";
export const IdentityLastActiveType = "IdentityLastActives.omni.sidero.dev";
export const IdentityStatusType = "IdentityStatuses.omni.sidero.dev";
