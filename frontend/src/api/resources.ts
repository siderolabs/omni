...
export const DefaultKubernetesVersion = "1.35.3";
...
export const DefaultTalosVersion = "1.12.6";
...
export const RoleType = "Roles.omni.sidero.dev";
export const RoleBindingType = "RoleBindings.omni.sidero.dev";
