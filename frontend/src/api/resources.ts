...
export const ClusterMachineExtendedConfigType = "ClusterMachineExtendedConfigs.omni.sidero.dev";
...
export const ClusterOperationStatusType = "ClusterOperationStatuses.omni.sidero.dev";
