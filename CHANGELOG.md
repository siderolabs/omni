...
* [`e2e5f08`](https://github.com/siderolabs/omni/commit/e2e5f08e0626ce2c0e3d70bcf6abcb8596fd53ac) chore: migrate uncompressed resources data
* [`fd888ab`](https://github.com/siderolabs/omni/commit/fd888ab190757a2495a1b954703e994c0769af15) refactor: track infra machine install status via a counter
* [`c6b7dd3`](https://github.com/siderolabs/omni/commit/c6b7dd3652dee7af176568e61a4bf024466dffec) test: extract static infra provider machine accept tests into hooks
* [`8db0e8d`](https://github.com/siderolabs/omni/commit/8db0e8d7c0d58eccc8ac2efaa8a067d0acb30346) test: fix `readyToUse` flag assertions in static infra provider tests
* [`4a436b4`](https://github.com/siderolabs/omni/commit/4a436b41027b14b0d4c25fc114a8b2e0db37fd83) fix: correctly handle conflict error in machine status handler
* [`6e910e1`](https://github.com/siderolabs/omni/commit/6e910e19f3c7cb36c8778d7ecee9779e1eb5028f) fix: update COSI runtime to fix watch retry errors
* [`2fcfc82`](https://github.com/siderolabs/omni/commit/2fcfc825eaf06e5af91dd0ec674396c2461b0a95) release(v0.46.0-beta.0): prepare release
